...
| Local reference | `<FC26 tools>\T3DbEngine.cs` | C# metadata/T3DB reader and atomic-save implementation | Read/write | Uses XML + table directory; local bundled DB differs from current DB. |
