...
| 10 | Transfer and loan system | Implemented | classic Team/Player workflows, `Fc26RosterToolsForm`, native empty-table append, reload-verified `transfers` history (player/seller/buyer/fee), transactional staged save | Maintain cancel/rollback fixtures for every loan variant. |
