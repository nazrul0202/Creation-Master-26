...
The selected package `D:\CM 26 Final\database` loads successfully: 279 main tables and 2 locale tables. Managed smoke verified 20,268 players, 218 nations, 808 teams, 808 managers, 180 stadiums, 53 leagues, 358 referees, 3,781 kits, and 837 formations.
...
2. Player-name Huffman output is now decoded as bytes with UTF-8/CP1252 validation rather than byte-to-char conversion. This fixes mojibake such as `Aarón`, `Köln`, `Nürnberg`, and `Białystok` while preserving database-native names.
