...
public class Trophy : Compobj
{
	...
	public override string ToString()
	{
		...
		return "Trophy n. " + base.Settings.m_asset_id;
	}
	...
	public override bool SaveToInitteams(StreamWriter w)
	{
		for (int i = 0; i < m_NEndTasks; i++)
		{
			...
			if (task.Action == "UpdateTable")
			{
				...
				{
					string text = null;
					text = ((initTeam.teamid < 0) ? (base.Id + "," + num + ",-1") : (base.Id + "," + num + "," + initTeam.teamid));
					w.WriteLine(text);
				}
			}
		}
	...
	public bool InsertStage(int stageIndex)
	{
		...
		string typeString = "S" + (stageIndex + 1);
	...
	{
		string typeString = "S" + (base.Stages.Count + 1);
	...
	{
		return "data/ui/imgassets/trophy/t" + id + ".dds";
	}

	public static string TrophyTemplateFileName()
	{
	...
	{
		return "data/sceneassets/tournament/tournament_" + assetId + "_0.rx3";
	}
	...
	{
		return new Rx3Signatures(349856, 32, new string[1] { "tournament_" + id });
	}

	private static string Wipe3DFileName(int assetId)
	{
		return "data/sceneassets/wipe3d/wipe_" + assetId + "_1_container_0.rx3";
	}

	public string Wipe3DFileName()
	{
		return Wipe3DFileName(base.Settings.m_asset_id);
	}

	public string Wipe3DTemplateFileName()
	{
		return "data/sceneassets/Wipe3d/wipe_#_1_container_0.rx3";
	}

	public Bitmap[] GetWipe3DTextures()
	{
		return FifaEnvironment.GetBmpsFromRx3(Wipe3DFileName());
	}

	public bool SetWipe3DTextures(Bitmap[] bitmaps)
	{
		if (bitmaps == null)
		{
			return false;
		}
		return FifaEnvironment.ImportBmpsIntoZdata(Wipe3DTemplateFileName(), base.Settings.m_asset_id, bitmaps, ECompressionMode.Chunkzip2);
	}

	public bool SetWipe3DTextures(string rx3FileName)
	{
		if (rx3FileName == null)
		{
			return false;
		}
		return FifaEnvironment.ImportFileIntoZdataAs(rx3FileName, Wipe3DFileName(), delete: false, ECompressionMode.Chunkzip);
	}

	public bool DeleteWipe3DContainer()
	{
		return FifaEnvironment.DeleteFromZdata(Wipe3DFileName());
	}

	public static string TrophyDdsFileName256(int id)
	{
		return "data/ui/imgassets/trophy256x256/t" + id + ".dds";
	}

	public static string TrophyTemplateFileName256()
	{
	...
	{
		return "data/ui/imgassets/trophy128x128/t" + id + ".dds";
	}

	public static string TrophyTemplateFileName128()
	{
	...
	{
		return "data/sceneassets/trophy/trophy_" + id + "_textures.rx3";
	}
	...
	{
		return "data/sceneassets/trophy/trophy_" + trophyId + ".rx3";
	}
