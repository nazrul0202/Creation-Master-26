...
public class Rank : IdObject
{
	...
	public override string ToString()
	{
		...
		if (base.Id != 0)
		{
			return "Team n." + base.Id + " of " + parentStage.ToString() + " / " + m_Group.ToString() + " of " + trophy.ToString();
		}
	...
	public string GetFromRankString()
	{
		...
		if (trophy.Id != trophy2.Id)
		{
			if (m_MoveFrom.Id != 0)
			{
				return "Team n." + m_MoveFrom.Id + " of " + m_MoveFrom.Group.ParentStage.ToString() + " / " + m_MoveFrom.Group.ToString() + " of " + m_MoveFrom.Group.ParentStage.Trophy.ToString();
			}
		...
		if (m_MoveFrom.Id != 0)
		{
			return "Team n." + m_MoveFrom.Id + " of " + m_MoveFrom.Group.ParentStage.ToString() + " / " + m_MoveFrom.Group.ToString();
		}
	...
	public string GetToRankString()
	{
		...
		if (trophy.Id != trophy2.Id)
		{
			if (m_MoveFrom.Id != 0)
			{
				return "Team n." + m_MoveTo.Id + " fof " + m_MoveTo.Group.ParentStage.ToString() + " / " + m_MoveTo.Group.ToString() + " of " + m_MoveFrom.Group.ParentStage.Trophy.ToString();
			}
		...
		if (m_MoveFrom.Id != 0)
		{
			return "Team n." + m_MoveTo.Id + " of " + m_MoveTo.Group.ParentStage.ToString() + " / " + m_MoveTo.Group.ToString();
		}
