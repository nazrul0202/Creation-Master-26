...
public static class GenericHead
{
	...
	public static int[] c_ShavenModels = new int[7] { 0, 25, 1, 43, 41, 46, 120 };
	...
	public static int[] c_ModernModels = new int[50]
	{
		17, 18, 19, 24, 39, 60, 61, 63, 64, 86,
		88, 89, 94, 123, 125, 126, 127, 128, 129, 130,
		131, 132, 133, 134, 135, 136, 137, 138, 139, 140,
		141, 142, 143, 144, 145, 146, 147, 148, 149, 150,
		151, 152, 153, 154, 155, 156, 157, 158, 203, 213
	};
	...
	public static int[] c_AfroModels = new int[9] { 71, 4, 27, 5, 6, 96, 3, 109, 110 };

	public static int[] c_HeadbendModels = new int[7] { 55, 56, 76, 81, 49, 91, 48 };

	public static int[] c_FemaleHairModels = new int[83]
	{
		500, 501, 502, 503, 504, 505, 506, 507, 508, 509,
		510, 511, 512, 513, 514, 515, 516, 517, 518, 519,
		520, 521, 522, 523, 524, 525, 526, 527, 528, 529,
	...
	{
		return modelSet switch
		{
			EHeadModelSet.African => c_AfricanModels[m_Randomizer.Next(c_AfricanModels.Length)], 
			EHeadModelSet.Asiatic => c_AsiaticModels[m_Randomizer.Next(c_AsiaticModels.Length)], 
			EHeadModelSet.Caucasic => c_CaucasicModels[m_Randomizer.Next(c_CaucasicModels.Length)], 
			EHeadModelSet.Latin => c_LatinModels[m_Randomizer.Next(c_LatinModels.Length)], 
			_ => 1, 
		};
	}
}
