...
public class Country : IdObject
{
	...
	public Country(int countryid)
		: base(countryid)
	{
		m_nationname = "Country " + countryid;
	...
	{
		return "data/ui/artassets/countryflags/f_" + id + ".big";
	}
	...
	{
		return "data/ui/imgassets/flags512x512/f_" + base.Id + ".dds";
	}

	public static string Flag512DdsFileName(int id)
	{
		return "data/ui/imgassets/flags512x512/f_" + id + ".dds";
	}
	...
	{
		return "data/ui/artassets/miniflags/flag_" + id + ".big";
	}
	...
	{
		return "data/ui/artassets/cardflags/" + id + ".big";
	}
	...
	{
		return "data/ui/imgassets/tiles/careerhub/countryshapes/c" + countryid + ".dds";
	}
