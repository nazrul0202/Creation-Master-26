...
public class CmSponsor
{
	...
	{
		return "data/ui/artassets/cmsponsors/cmsponsor_" + id + ".big";
	}

	public static string CmSponsorDdsFileName(int id)
	{
		return "data/ui/imgassets/cmsponsors/cmsponsors" + id + ".dds";
	}
	...
	{
		return "data/ui/artassets/cmsponsorssmall/cmsponsor_sml_" + id + ".big";
	}
