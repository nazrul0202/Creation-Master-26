...
public class UgcFile
{
		...
		for (int i = 0; i < table.NValidRecords; i++)
		{
			...
			for (int j = 0; j < table3.NValidRecords; j++)
			{
				...
				if (record2.GetAndCheckIntField(FI.cz_teams_teamid) == andCheckIntField)
				{
					...
					string text = FifaEnvironment.TempFolder + "\\" + andCheckIntField2 + ".png";
					if (File.Exists(text))
					{
						bitmap = new Bitmap(text);
					}
					text = FifaEnvironment.TempFolder + "\\" + andCheckIntField3 + ".png";
					if (File.Exists(text))
					{
	...
	public void Import(string xmlFileName, bool useGraphics, ToolStripStatusLabel statusBar)
	{
		...
		for (int n = 0; n < table7.NValidRecords; n++)
		{
			...
			int andCheckIntField3 = record3.GetAndCheckIntField(FI.teams_assetid);
			int andCheckIntField4 = record3.GetAndCheckIntField(FI.teams_teamid);
			Team team = null;
			bool flag2 = false;
			if (andCheckIntField3 != 33554432)
			{
				team = (Team)FifaEnvironment.Teams.SearchId(andCheckIntField3);
				if (team != null)
				{
			...
			array2[n] = team;
			team.assetid = andCheckIntField4;
			...
			andCheckIntField3 = array2[n].assetid;
			Bitmap bitmap4 = null;
			Bitmap bitmap5 = null;
			if (useGraphics)
			{
				for (int num4 = 0; num4 < table11.NValidRecords; num4++)
				{
					...
					if (record4.GetAndCheckIntField(FI.cz_teams_teamid) == andCheckIntField3)
					{
						int andCheckIntField5 = record4.GetAndCheckIntField(FI.cz_teams_hascrestimage);
						int andCheckIntField6 = record4.GetAndCheckIntField(FI.cz_teams_hassponsorimage);
						string text2 = FifaEnvironment.TempFolder + "\\" + andCheckIntField5 + ".png";
						...
						text2 = FifaEnvironment.TempFolder + "\\" + andCheckIntField6 + ".png";
						if (File.Exists(text2))
						{
			...
			for (int num5 = 0; num5 < table10.NValidRecords; num5++)
			{
				...
				int andCheckIntField7 = record5.GetAndCheckIntField(FI.cz_teamkits_kitid);
				int andCheckIntField8 = record5.GetAndCheckIntField(FI.cz_teamkits_teamid);
				int andCheckIntField9 = record5.GetAndCheckIntField(FI.cz_teamkits_kittypeid);
				string text3 = Kit.KitTextureFileName(andCheckIntField7, 0, 0);
				if (team.assetid != andCheckIntField8)
				{
					continue;
				}
				Kit kit = new Kit(FifaEnvironment.Kits.GetNewId(), team.Id, andCheckIntField9);
				FifaEnvironment.Kits.Add(kit);
				kit.LinkTeam(FifaEnvironment.Teams);
				...
				Color color = (kit.TeamColor1 = Color.FromArgb(255, red, green, blue));
				...
				Color color3 = (kit.TeamColor2 = Color.FromArgb(255, red, green, blue));
				...
				Color color5 = (kit.TeamColor3 = Color.FromArgb(255, red, green, blue));
				...
				Kit.KitTextureFileName(team.Id, andCheckIntField9, 0);
				Kit kit2 = FifaEnvironment.Kits.GetKit(andCheckIntField7, 0);
				...
				if (useGraphics && kit2 != null)
				{
					...
					GraphicUtil.ColorizeRGB(kitTextures[1], color, color3, color5, 0, 1024);
					if (bitmap10 != null)
					{
						GraphicUtil.PrepareToColorize(bitmap10, 25, 231);
						GraphicUtil.ColorizeRGB(bitmap10, color, color3, color5, 25, 231);
					}
		...
		for (int num14 = 0; num14 < table3.NValidRecords; num14++)
		{
			...
			int andCheckIntField10 = record6.GetAndCheckIntField(FI.stadiumassignments_teamid);
			for (int num15 = 0; num15 < array2.Length; num15++)
			{
				if (array2[num15].assetid == andCheckIntField10)
				{
		...
		for (int num16 = 0; num16 < table4.NValidRecords; num16++)
		{
			...
			int andCheckIntField11 = record7.GetAndCheckIntField(FI.teamstadiumlinks_teamid);
			for (int num17 = 0; num17 < array2.Length; num17++)
			{
				if (array2[num17].assetid == andCheckIntField11)
				{
		...
		for (int num18 = 0; num18 < table11.NValidRecords; num18++)
		{
			...
			int andCheckIntField12 = record8.GetAndCheckIntField(FI.cz_teams_teamid);
			for (int num19 = 0; num19 < array2.Length; num19++)
			{
				if (array2[num19].assetid == andCheckIntField12)
				{
		...
		for (int num20 = 0; num20 < table6.NValidRecords; num20++)
		{
			...
			int andCheckIntField13 = obj.GetAndCheckIntField(FI.formations_teamid);
			for (int num21 = 0; num21 < array2.Length; num21++)
			{
				if (array2[num21].assetid == andCheckIntField13)
				{
					array2[num21].Formation = formation2;
					array2[num21].formationid = formation2.Id;
					break;
				}
			}
		}
		...
		int num22 = 230000;
		for (int num23 = 0; num23 < table9.NValidRecords; num23++)
		{
			Record record9 = table9.Records[num23];
			int andCheckIntField14 = record9.GetAndCheckIntField(FI.players_playerid);
			int num24 = 0;
			for (int num25 = 0; num25 < table12.NValidRecords; num25++)
			{
				Record record10 = table12.Records[num25];
				if (record10.GetAndCheckIntField(FI.cz_players_playerid) == andCheckIntField14)
				{
					num24 = record10.GetAndCheckIntField(FI.cz_players_assetid);
					break;
				}
			}
			Player player = null;
			...
			if (num24 != 0)
			{
				player = (Player)FifaEnvironment.Players.SearchId(num24);
				if (player != null)
				{
					flag3 = true;
				}
			...
			if (player == null)
			{
				...
				string text5 = null;
				string text6 = null;
				for (int num26 = 0; num26 < table8.NValidRecords; num26++)
				{
					Record record11 = table8.Records[num26];
					if (record11.IntField[FI.editedplayernames_playerid] == andCheckIntField14)
					{
				...
				if (player == null)
				{
					if (num24 != 0)
					{
						player = new Player(table9.Records[num23]);
						player.Id = num24;
					}
					else
					{
						num22 = FifaEnvironment.Players.GetNextId(num22);
						player = new Player(table9.Records[num23]);
						player.Id = num22;
					}
			...
			array3[num23] = player;
			player.m_assetid = andCheckIntField14;
		}
		for (int num27 = 0; num27 < table.NValidRecords; num27++)
		{
			Record obj2 = table.Records[num27];
			int andCheckIntField15 = obj2.GetAndCheckIntField(FI.leagueteamlinks_leagueid);
			int andCheckIntField16 = obj2.GetAndCheckIntField(FI.leagueteamlinks_teamid);
			League league2 = null;
			switch (andCheckIntField15)
			{
			case 384:
			...
			case 388:
			case 389:
				league2 = array[andCheckIntField15 - 385];
				break;
			}
			if (league2 == null)
			{
			...
			{
				if (array2[num28].assetid == andCheckIntField16)
				{
					league2.AddTeam(array2[num28]);
					break;
				}
			}
		}
		for (int num29 = 0; num29 < table5.NValidRecords; num29++)
		{
			Record record12 = table5.Records[num29];
			int andCheckIntField17 = record12.GetAndCheckIntField(FI.teamplayerlinks_playerid);
			int andCheckIntField18 = record12.GetAndCheckIntField(FI.teamplayerlinks_teamid);
			for (int num30 = 0; num30 < array3.Length; num30++)
			{
				if (array3[num30].m_assetid != andCheckIntField17)
				{
					continue;
				}
				for (int num31 = 0; num31 < array2.Length; num31++)
				{
					if (array2[num31].assetid == andCheckIntField18)
					{
						array3[num30].PlayFor(array2[num31]);
						TeamPlayer value = new TeamPlayer(record12, array3[num30], array2[num31]);
						array2[num31].Roster.Add(value);
						if (array2[num31].captainid == array3[num30].m_assetid)
						{
							array2[num31].PlayerCaptain = array3[num30];
							array2[num31].captainid = array3[num30].Id;
						}
						if (array2[num31].freekicktakerid == array3[num30].m_assetid)
						{
							array2[num31].PlayerFreeKick = array3[num30];
							array2[num31].freekicktakerid = array3[num30].Id;
						}
						if (array2[num31].leftcornerkicktakerid == array3[num30].m_assetid)
						{
							array2[num31].PlayerLeftCorner = array3[num30];
							array2[num31].leftcornerkicktakerid = array3[num30].Id;
						}
						if (array2[num31].longkicktakerid == array3[num30].m_assetid)
						{
							array2[num31].PlayerLongKick = array3[num30];
							array2[num31].longkicktakerid = array3[num30].Id;
						}
						if (array2[num31].penaltytakerid == array3[num30].m_assetid)
						{
							array2[num31].PlayerPenalty = array3[num30];
							array2[num31].penaltytakerid = array3[num30].Id;
						}
						if (array2[num31].rightcornerkicktakerid == array3[num30].m_assetid)
						{
							array2[num31].PlayerRightCorner = array3[num30];
							array2[num31].rightcornerkicktakerid = array3[num30].Id;
						}
						break;
					}
				}
		...
		{
			array3[num32].m_assetid = array3[num32].Id;
		}
		for (int num33 = 0; num33 < array2.Length; num33++)
		{
			array2[num33].assetid = array2[num33].Id;
		}
		if (statusBar != null)
		{
			statusBar.Text = "Importing complete";
	...
	public void UpdateRosters(string xmlFileName, bool useKitGraphics, ToolStripStatusLabel statusBar)
	{
		...
		int num3 = 230000;
		int num4 = 0;
		for (int num5 = 0; num5 < table6.NValidRecords; num5++)
		{
			Record record4 = table6.Records[num5];
			int andCheckIntField4 = record4.GetAndCheckIntField(FI.players_playerid);
			bool flag = false;
			for (int num6 = 0; num6 < table2.NValidRecords; num6++)
			{
				Record record5 = table2.Records[num6];
				...
				{
					if (array[num7].assetid == andCheckIntField5)
					{
						flag = true;
						break;
					}
			...
			string text3 = null;
			int num8 = 0;
			for (int num9 = 0; num9 < table7.NValidRecords; num9++)
			{
				Record record6 = table7.Records[num9];
				if (record6.GetAndCheckIntField(FI.cz_players_playerid) == andCheckIntField4)
				{
					num8 = record6.GetAndCheckIntField(FI.cz_players_assetid);
					break;
				}
			}
			Player player = null;
			if (num8 != 0)
			{
				player = (Player)FifaEnvironment.Players.SearchId(num8);
			}
			if (player == null)
			{
				for (int num10 = 0; num10 < table5.NValidRecords; num10++)
				{
					Record record7 = table5.Records[num10];
				...
				if (player == null)
				{
					...
					player = new Player(table6.Records[num5]);
					player.Id = num3;
					player.firstname = firstname;
					player.lastname = text;
					player.commonname = text2;
		...
		for (int num11 = 0; num11 < table2.NValidRecords; num11++)
		{
			Record record8 = table2.Records[num11];
			...
			{
				if (array2[num12].m_assetid != andCheckIntField6)
				{
					continue;
				}
				for (int num13 = 0; num13 < num2; num13++)
				{
					if (array[num13].assetid == andCheckIntField7)
					{
						array2[num12].PlayFor(array[num13]);
						TeamPlayer value = new TeamPlayer(record8, array2[num12], array[num13]);
						array[num13].Roster.Add(value);
						if (array[num13].captainid == array2[num12].m_assetid)
						{
							array[num13].PlayerCaptain = array2[num12];
							array[num13].captainid = array2[num12].Id;
						}
						if (array[num13].freekicktakerid == array2[num12].m_assetid)
						{
							array[num13].PlayerFreeKick = array2[num12];
							array[num13].freekicktakerid = array2[num12].Id;
						}
						if (array[num13].leftfreekicktakerid == array2[num12].m_assetid)
						{
							array[num13].PlayerLeftFreeKick = array2[num12];
							array[num13].leftfreekicktakerid = array2[num12].Id;
						}
						if (array[num13].rightfreekicktakerid == array2[num12].m_assetid)
						{
							array[num13].PlayerRightFreeKick = array2[num12];
							array[num13].rightfreekicktakerid = array2[num12].Id;
						}
						if (array[num13].leftcornerkicktakerid == array2[num12].m_assetid)
						{
							array[num13].PlayerLeftCorner = array2[num12];
							array[num13].leftcornerkicktakerid = array2[num12].Id;
						}
						if (array[num13].longkicktakerid == array2[num12].m_assetid)
						{
							array[num13].PlayerLongKick = array2[num12];
							array[num13].longkicktakerid = array2[num12].Id;
						}
						if (array[num13].penaltytakerid == array2[num12].m_assetid)
						{
							array[num13].PlayerPenalty = array2[num12];
							array[num13].penaltytakerid = array2[num12].Id;
						}
						if (array[num13].rightcornerkicktakerid == array2[num12].m_assetid)
						{
							array[num13].PlayerRightCorner = array2[num12];
							array[num13].rightcornerkicktakerid = array2[num12].Id;
						}
						break;
					}
				}
		...
		{
			array2[num14].m_assetid = array2[num14].Id;
		}
		for (int num15 = 0; num15 < array.Length; num15++)
		{
			array[num15].assetid = array[num15].Id;
		}
		if (statusBar != null)
		{
