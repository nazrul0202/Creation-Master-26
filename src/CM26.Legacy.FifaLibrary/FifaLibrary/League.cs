...
public class League : IdObject
{
	...
	public int leaguetimeslice
	{
		get
		{
			return m_leaguetimeslice;
		}
		set
		{
			m_leaguetimeslice = value;
		}
	}
	...
	{
		return "data/sceneassets/leaguelogo/leaguelogo_" + id + "_textures.rx3";
	}
	...
	{
		return "data/sceneassets/leaguelogo/leaguelogo_" + id + ".rx3";
	}
	...
	public static string AnimLogoDdsFileName(int id, int year)
	{
		if (year == 14)
		{
			return "data/ui/imgassets/league/l" + id + ".dds";
		}
		return "data/ui/imgassets/league/light/l" + id + ".dds";
	}
	...
	public static string AnimLogoTemplateFileName()
	{
	...
	{
		return "data/ui/imgassets/league/dark/l" + id + ".dds";
	}

	public static string AnimLogoDarkTemplateFileName()
	{
	...
	public static string Logo512x128DdsFileName(int id)
	{
		...
		return "data/ui/imgassets/league512x128/light/l" + id + ".dds";
	}

	public static string Logo512x128TemplateFileName()
	{
		if (FifaEnvironment.Year == 14)
		{
			return null;
	...
	public static string Logo512x128DarkDdsFileName(int id)
	{
		...
		return "data/ui/imgassets/league512x128/dark/l" + id + ".dds";
	}

	public static string Logo512x128DarkTemplateFileName()
	{
		if (FifaEnvironment.Year == 14)
		{
			return null;
	...
	public static string TinyLogoDdsFileName(int id, int year)
	{
		if (year == 14)
		{
			return "data/ui/imgassets/leaguelogos_tiny/l" + id + ".dds";
		}
		return "data/ui/imgassets/leaguelogos_tiny/light/l" + id + ".dds";
	}
	...
	public static string TinyLogoTemplateFileName()
	{
		if (FifaEnvironment.Year == 14)
		{
	...
	{
		return "data/ui/imgassets/leaguelogos_tiny/dark/l" + id + ".dds";
	}

	public static string TinyLogoDarkTemplateFileName()
	{
	...
	public static string SmallLogoDdsFileName(int id)
	{
		if (FifaEnvironment.Year == 14)
		{
			return "data/ui/imgassets/leaguelogos_sm/l" + id + ".dds";
		}
		return null;
	}
	...
	{
		return "data/ui/imgassets/leaguelogos_sm/dark/l" + id + ".dds";
	}
