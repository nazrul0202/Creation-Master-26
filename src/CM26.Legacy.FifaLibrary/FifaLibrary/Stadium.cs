...
public class Stadium : IdObject
{
	...
	public int StadiumLanguage
	{
		get
		{
			return m_stadiumlanguage;
		}
		set
		{
			m_stadiumlanguage = value;
		}
	}
	...
	public void FillFromAudiostadium(Record r)
	{
		m_stadiumlanguage = r.GetAndCheckIntField(FI.audiostadium_stadiumpalanguageindex);
	}
	...
	public void SaveAudiostadium(Record r)
	{
		r.IntField[FI.audiostadium_stadiumid] = base.Id;
		r.IntField[FI.audiostadium_stadiumpalanguageindex] = m_stadiumlanguage;
	}
	...
	{
		return "data/ui/artassets/stadium/stadium_" + stadiumid + "_" + timeofday + ".big";
	}

	public string PreviewBigFileName(int timeofday)
	{
		return "data/ui/artassets/stadium/stadium_" + base.Id + "_" + timeofday + ".big";
	}
	...
	{
		return FifaEnvironment.SetArtasset(ids: new int[2] { base.Id, timeofday }, templateBigName: PreviewTemplateFileName(), ddsName: PreviewDdsFileName(), bitmap: bitmap);
	}
	...
	{
		return "data/ui/artassets/stadiumsbig/st_" + stadiumid + "_" + timeofday + ".big";
	}

	public string PreviewLargeBigFileName(int timeofday)
	{
		return "data/ui/artassets/stadiumsbig/st_" + base.Id + "_" + timeofday + ".big";
	}
	...
	{
		return FifaEnvironment.SetArtasset(ids: new int[2] { base.Id, timeofday }, templateBigName: PreviewLargeTemplateFileName(), ddsName: PreviewLargeDdsFileName(), bitmap: bitmap);
	}
	...
	{
		return "data/sceneassets/stadium/stadium_" + stadiumid + "_" + timeofday + "_textures.rx3";
	}

	public string TexturesFileName(int timeofday)
	{
		return "data/sceneassets/stadium/stadium_" + base.Id + "_" + timeofday + "_textures.rx3";
	}
	...
	{
		return "data/sceneassets/stadium/stadium_" + stadiumid + ".rx3";
	}

	public string ModelFileName()
	{
		return "data/sceneassets/stadium/stadium_" + base.Id + ".rx3";
	}
	...
	{
		return "data/sceneassets/crowdplacement/crowd_" + stadiumid + "_" + timeofday + ".dat";
	}

	public string CrowdFileName(int timeofday)
	{
		return "data/sceneassets/crowdplacement/crowd_" + base.Id + "_" + timeofday + ".dat";
	}
	...
	{
		return "data/sceneassets/radiosity/stadium_" + stadiumid + ".rad";
	}

	public string RadiosityFileName()
	{
		return "data/sceneassets/radiosity/stadium_" + base.Id + ".rad";
	}
	...
	public static string[] GlaresLightFileNames(int stadiumid, int timeofday)
	{
		...
		{
			"data/sceneassets/fx/glares_" + stadiumid + "_0.lnx",
			"data/sceneassets/fx/glares_" + stadiumid + "_0.rx3",
			"data/sceneassets/fx/glares_" + stadiumid + "_1.lnx",
			"data/sceneassets/fx/glares_" + stadiumid + "_1.rx3",
			"data/sceneassets/fx/glares_" + stadiumid + "_3.lnx",
			"data/sceneassets/fx/glares_" + stadiumid + "_3.rx3",
			"data/sceneassets/fx/glares_" + stadiumid + "_4.lnx",
			"data/sceneassets/fx/glares_" + stadiumid + "_4.rx3"
		} : new string[8]
		{
			"data/sceneassets/fx/glares_" + stadiumid + "_" + timeofday + "_0.lnx",
			"data/sceneassets/fx/glares_" + stadiumid + "_" + timeofday + "_0.rx3",
			"data/sceneassets/fx/glares_" + stadiumid + "_" + timeofday + "_1.lnx",
			"data/sceneassets/fx/glares_" + stadiumid + "_" + timeofday + "_1.rx3",
			"data/sceneassets/fx/glares_" + stadiumid + "_" + timeofday + "_2.lnx",
			"data/sceneassets/fx/glares_" + stadiumid + "_" + timeofday + "_2.rx3",
			"data/sceneassets/fx/glares_" + stadiumid + "_" + timeofday + "_3.lnx",
			"data/sceneassets/fx/glares_" + stadiumid + "_" + timeofday + "_3.rx3"
		};
	}
	...
	public string[] GlaresLightFileNames()
	{
		return new string[8]
		{
			"data/sceneassets/fx/glares_" + base.Id + "_0.lnx",
			"data/sceneassets/fx/glares_" + base.Id + "_0.rx3",
			"data/sceneassets/fx/glares_" + base.Id + "_1.lnx",
			"data/sceneassets/fx/glares_" + base.Id + "_1.rx3",
			"data/sceneassets/fx/glares_" + base.Id + "_3.lnx",
			"data/sceneassets/fx/glares_" + base.Id + "_3.rx3",
			"data/sceneassets/fx/glares_" + base.Id + "_4.lnx",
			"data/sceneassets/fx/glares_" + base.Id + "_4.rx3"
		};
	}
	...
	public bool CloneGlares(int newId)
	{
		...
		for (int i = 0; i < array.Length; i++)
		{
			if (Path.GetExtension(array[i]).ToLower() == ".lnx")
			{
				...
				string text = "glares_" + base.Id + "_";
				string newValue = "glares_" + newId + "_";
