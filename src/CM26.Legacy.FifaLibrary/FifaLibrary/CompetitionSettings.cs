...
public class CompetitionSettings
{
	...
	public bool IsStringProperty(string property)
	{
		return property switch
		{
			...
			"rule_offsides" => true, 
			"rule_injuries" => true, 
			"match_stagetype" => true, 
			"match_matchsituation" => true, 
			"match_endruleleague" => true, 
			"match_endruleko1leg" => true, 
			"match_endruleko2leg1" => true, 
			"match_endruleko2leg2" => true, 
			"match_endrulefriendly" => true, 
			"match_canusefancards" => true, 
			"standings_sort" => true, 
			"schedule_seasonstartmonth" => true, 
			_ => false, 
		};
	}
	...
	public int IsMultipleProperty(string property)
	{
		return property switch
		{
			"match_endruleko1leg" => m_match_endruleko1leg.Length, 
			"match_endruleko2leg2" => m_match_endruleko2leg2.Length, 
			"standings_sort" => m_standings_sort.Length, 
			"info_slot_promo" => m_info_slot_promo.Length, 
			"info_slot_promo_poss" => m_info_slot_promo_poss.Length, 
			"info_slot_releg" => m_info_slot_releg.Length, 
			"info_slot_releg_poss" => m_info_slot_releg_poss.Length, 
			"info_color_slot_champ_cup" => m_info_color_slot_champ_cup.Length, 
			"info_color_slot_euro_league" => m_info_color_slot_euro_league.Length, 
			"info_color_slot_promo" => m_info_color_slot_promo.Length, 
			"info_color_slot_promo_poss" => m_info_color_slot_promo_poss.Length, 
			"info_color_slot_releg" => m_info_color_slot_releg.Length, 
			"info_color_slot_releg_poss" => m_info_color_slot_releg_poss.Length, 
			"match_stadium" => m_match_stadium.Length, 
			"info_color_slot_adv_group" => m_info_color_slot_adv_group.Length, 
			"info_special_team_id" => m_info_special_team_id.Length, 
			_ => 1, 
		};
	}
	...
	public string GetProperty(string property, int index, out bool isSpecific)
	{
		...
		{
			text = m_ParentSettings.GetProperty(property, index, out var _);
		}
		if (text == null)
		{
			text = string.Empty;
	...
	public void LoadProperty(string property, string val)
	{
		...
		case "match_endruleko2leg2":
			...
			return;
		case "match_endrulefriendly":
			m_match_endrulefriendly = val;
			return;
		case "match_canusefancards":
			m_match_canusefancards = val;
			return;
		case "match_celebrationlevel":
			m_match_celebrationlevel = val;
			return;
		case "info_prize_money":
			m_info_prize_money = Convert.ToInt32(val);
			return;
		case "info_prize_money_drop":
	...
	public string GetSpecificProperty(string property, int index)
	{
		...
		return property switch
		{
			"asset_id" => m_asset_id.ToString(), 
			"rule_numsubsmatch" => m_rule_numsubsmatch.ToString(), 
			"schedule_checkconflict" => m_schedule_checkconflict.ToString(), 
			"schedule_compdependency" => m_schedule_compdependency.ToString(), 
			"schedule_internationaldependency" => m_schedule_internationaldependency.ToString(), 
			"schedule_forcecomp" => m_schedule_forcecomp.ToString(), 
			"advance_teamcompdependency" => m_advance_teamcompdependency.ToString(), 
			"info_league_promo" => m_info_league_promo.ToString(), 
			"info_league_releg" => m_info_league_releg.ToString(), 
			"info_special_team_id" => m_info_special_team_id[index].ToString(), 
			"advance_random_draw_rvrny" => m_advance_random_draw_event.ToString(), 
			"advance_randomdraw" => m_advance_randomdraw.ToString(), 
			"advance_calccompavgs" => m_advance_calccompavgs.ToString(), 
			"advance_maxteamsassoc" => m_advance_maxteamsassoc.ToString(), 
			"advance_maxteamsgroup" => m_advance_maxteamsgroup.ToString(), 
			"advance_maxteamsstageref" => m_advance_maxteamsstageref.ToString(), 
			"advance_standingskeep" => m_advance_standingskeep.ToString(), 
			"advance_standingsrank" => m_advance_standingsrank.ToString(), 
			"schedule_matchreplay" => m_schedule_matchreplay.ToString(), 
			"schedule_reversed" => m_schedule_reversed.ToString(), 
			"schedule_year_real" => m_schedule_year_real.ToString(), 
			"standings_checkrank" => m_standings_checkrank.ToString(), 
			_ => null, 
		};
	}
