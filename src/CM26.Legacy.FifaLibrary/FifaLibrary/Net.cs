...
public class Net : IdObject
{
	...
	{
		return "data/sceneassets/goalnet/netcolor_" + netid + "_textures.rx3";
	}

	public static string RevModNetFileName(int teamId)
	{
		return "data/sceneassets/goalnet/specificnetcolor_" + teamId + "_0_textures.rx3";
	}
	...
	public static bool IsRevModNetPresent(int teamId)
	{
		return File.Exists(FifaEnvironment.RootDir + "\\" + RevModNetFileName(teamId));
	}
