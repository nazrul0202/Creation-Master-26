...
public class CmsDataSet : DataSet
{
	...
	public class CmsDataTableDataTable : TypedTableBase<CmsDataTableRow>
	{
		...
		public CmsDataTableRow AddCmsDataTableRow(string Group, string Name, int Id)
		{
			...
			object[] itemArray = new object[3] { Group, Name, Id };
			cmsDataTableRow.ItemArray = itemArray;
	...
	public class CmsDataTableRow : DataRow
	{
		...
		public string Group
		{
			get
			{
				...
				{
					throw new StrongTypingException("Il valore della colonna 'Group' nella tabella 'CmsDataTable' è DBNull.", innerException);
				}
			}
			set
			{
		...
		public string Name
		{
			get
			{
				...
				{
					throw new StrongTypingException("Il valore della colonna 'Name' nella tabella 'CmsDataTable' è DBNull.", innerException);
				}
			}
			set
			{
		...
		public int Id
		{
			get
			{
				...
				{
					throw new StrongTypingException("Il valore della colonna 'Id' nella tabella 'CmsDataTable' è DBNull.", innerException);
				}
			}
			set
			{
