...
public class Adboard : IdObject
{
	...
	{
		return "data/sceneassets/adboard/adboard_" + adboardid + "_0.rx3";
	}

	public static string RevModTeamAdboardFileName(int teamId)
	{
		return "data/sceneassets/adboard/specificadboard_" + teamId + "_0_0_0.rx3";
	}

	public static string RevModTornamentAdboardFileName(int tournamentAssetId)
	{
		return "data/sceneassets/adboard/specificadboard_0_" + tournamentAssetId + "_0_0.rx3";
	}
