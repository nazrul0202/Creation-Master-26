...
public class FI
{
	...
	public static int teams_cityid = -1;

	public static int teams_clubworth = -1;
	...
	public static int teams_domesticcups = -1;
	...
	public static int teams_iscompetitionscarfenabled = -1;

	public static int teams_jerseytype = -1;

	public static int teams_latitude = -1;

	public static int teams_leaguetitles = -1;
	...
	public static int teams_opponentstrongthreshold = -1;

	public static int teams_opponentweakthreshold = -1;
	...
	public static int teams_popularity = -1;

	public static int teams_powid = -1;

	public static int teams_profitability = -1;
	...
	public static int teams_skinnyflags = -1;

	public static int teams_stanchionflamethrower = -1;
	...
	public static int teams_teamstadiumcapacity = -1;

	public static int teams_trainingstadium = -1;

	public static int teams_trait1vequal = -1;

	public static int teams_trait1vstrong = -1;

	public static int teams_trait1vweak = -1;

	public static int teams_transferbudget = -1;

	public static int teams_utcoffset = -1;

	public static int teams_youthdevelopment = -1;
	...
	public static int teamkits_isembargoed = -1;
	...
	public static int teamkits_jerseynumbercolorprimb = -1;

	public static int teamkits_jerseynumbercolorprimg = -1;

	public static int teamkits_jerseynumbercolorprimr = -1;

	public static int teamkits_jerseynumbercolorsecb = -1;

	public static int teamkits_jerseynumbercolorsecg = -1;

	public static int teamkits_jerseynumbercolorsecr = -1;

	public static int teamkits_jerseynumbercolorterb = -1;

	public static int teamkits_jerseynumbercolorterg = -1;

	public static int teamkits_jerseynumbercolorterr = -1;
	...
	public static int teamkits_shortsnumbercolorprimb = -1;

	public static int teamkits_shortsnumbercolorprimg = -1;

	public static int teamkits_shortsnumbercolorprimr = -1;

	public static int teamkits_shortsnumbercolorsecb = -1;

	public static int teamkits_shortsnumbercolorsecg = -1;

	public static int teamkits_shortsnumbercolorsecr = -1;

	public static int teamkits_shortsnumbercolorterb = -1;

	public static int teamkits_shortsnumbercolorterg = -1;

	public static int teamkits_shortsnumbercolorterr = -1;
	...
	public static int teamkits_shortstyle = -1;

	public static int teamkits_teamcolorprimb = -1;

	public static int teamkits_teamcolorprimg = -1;

	public static int teamkits_teamcolorprimpercent = -1;
	...
	public static int teamkits_teamcolorsecpercent = -1;
	...
	public static int teamkits_teamcolortertpercent = -1;
	...
	public static int stadiums_cityid = -1;

	public static int stadiums_colorregion = -1;

	public static int stadiums_countrycode = -1;

	public static int stadiums_defaultseason = -1;

	public static int stadiums_defaulttime = -1;

	public static int stadiums_defaultweather = -1;

	public static int stadiums_dlc = -1;

	public static int stadiums_genericrank = -1;

	public static int stadiums_gmavailability = -1;

	public static int stadiums_goalnetads = -1;

	public static int stadiums_goalnetstanchioncolor1b = -1;

	public static int stadiums_goalnetstanchioncolor1g = -1;

	public static int stadiums_goalnetstanchioncolor1r = -1;

	public static int stadiums_goalnetstanchioncolor2b = -1;

	public static int stadiums_goalnetstanchioncolor2g = -1;

	public static int stadiums_goalnetstanchioncolor2r = -1;

	public static int stadiums_hometeamid = -1;

	public static int stadiums_inflatables = -1;
	...
	public static int stadiums_isstadiumavailable = -1;

	public static int stadiums_languageregion = -1;

	public static int stadiums_name = -1;

	public static int stadiums_pitchtarps = -1;

	public static int stadiums_policetypecode = -1;

	public static int stadiums_replay360degree = -1;

	public static int stadiums_rotation360degree = -1;
	...
	public static int referee_hairstylecode = -1;
	...
	public static int referee_headvariation = -1;
	...
	public static int referee_shortstyle = -1;
	...
	public static int referee_socklengthcode = -1;
	...
	public static int players_animpenaltiesapproachcode = -1;
	...
	public static int players_composure = -1;
	...
	public static int players_hairstylecode = -1;
	...
	public static int players_headvariation = -1;
	...
	public static int players_iscustomized = -1;
	...
	public static int players_modifier = -1;
	...
	public static int players_tattoobackneck = -1;

	public static int players_tattooleftarm = -1;

	public static int players_tattooleftneck = -1;

	public static int players_tattoorightarm = -1;

	public static int players_tattoorightneck = -1;
	...
	public static int career_presignedcontract_signdate = -1;

	public static int career_presignedcontract_iscomingthisseason = -1;

	public static int career_presignedcontract_offerteamid = -1;

	public static int career_presignedcontract_offerid = -1;

	public static int career_presignedcontract_future_fee = -1;

	public static int career_presignedcontract_performancebonuscount = -1;

	public static int career_presignedcontract_exchangeplayerwage = -1;

	public static int career_presignedcontract_currentcontractwage = -1;

	public static int career_presignedcontract_exchangeplayerid = -1;

	public static int career_presignedcontract_offeredfee = -1;

	public static int career_presignedcontract_offeredwage = -1;

	public static int career_presignedcontract_performancebonusvalue = -1;

	public static int career_presignedcontract_performancebonustype = -1;

	public static int career_presignedcontract_completedate = -1;

	public static int career_presignedcontract_isloanbuy = -1;

	public static int career_presignedcontract_signonbonus = -1;

	public static int career_presignedcontract_teamid = -1;

	public static int career_presignedcontract_offeredcontracttype = -1;

	public static int career_presignedcontract_releaseclause = -1;

	public static int career_presignedcontract_playerid = -1;

	public static int career_presignedcontract_squadrole = -1;
	...
	public static int manager_managerid = -1;

	public static int manager_headid = -1;

	public static int manager_height = -1;

	public static int manager_hashighqualityhead = -1;

	public static int manager_gender = -1;

	public static int manager_suitvariationid = -1;

	public static int manager_teamid = -1;

	public static int manager_suittypeid = -1;

	public static int manager_eyecolorcode = -1;

	public static int manager_headclasscode = -1;

	public static int manager_skintonecode = -1;

	public static int manager_bodytypecode = -1;
	...
	public static int leagues_isbannerenabled = -1;

	public static int leagues_iscompetitioncrowdcardsenabled = -1;

	public static int leagues_iscompetitionpoleflagenabled = -1;

	public static int leagues_iscompetitionscarfenabled = -1;
	...
	public static int defaultteamdata_formationfullnameid = -1;
	...
	public static int default_teamsheets_customsub0in = -1;

	public static int default_teamsheets_customsub0out = -1;

	public static int default_teamsheets_customsub1in = -1;

	public static int default_teamsheets_customsub1out = -1;

	public static int default_teamsheets_customsub2in = -1;

	public static int default_teamsheets_customsub2out = -1;
	...
	public static int default_teamsheets_formationaudioid = -1;

	public static int default_teamsheets_formationfullnameid = -1;
	...
	public static int default_teamsheets_playerid42 = -1;

	public static int default_teamsheets_playerid43 = -1;

	public static int default_teamsheets_playerid44 = -1;

	public static int default_teamsheets_playerid45 = -1;

	public static int default_teamsheets_playerid46 = -1;

	public static int default_teamsheets_playerid47 = -1;

	public static int default_teamsheets_playerid48 = -1;

	public static int default_teamsheets_playerid49 = -1;

	public static int default_teamsheets_playerid5 = -1;

	public static int default_teamsheets_playerid50 = -1;

	public static int default_teamsheets_playerid51 = -1;
	...
	public static int default_teamsheets_sourceformationid = -1;
	...
	public static int competition_abbapenalties = -1;

	public static int competition_adboardplacement = -1;

	public static int competition_adboardplacementstage = -1;

	public static int competition_authenticpodiumskin = -1;

	public static int competition_ballid = -1;

	public static int competition_colorregion = -1;

	public static int competition_competitioncolor1b = -1;

	public static int competition_competitioncolor1g = -1;

	public static int competition_competitioncolor1r = -1;

	public static int competition_competitioncolor2b = -1;

	public static int competition_competitioncolor2g = -1;

	public static int competition_competitioncolor2r = -1;

	public static int competition_competitionid = -1;

	public static int competition_competitionimportance = -1;

	public static int competition_crowdskintonecode = -1;

	public static int competition_goaljingle = -1;

	public static int competition_goalnetads = -1;

	public static int competition_inflatables = -1;

	public static int competition_introconfetti = -1;

	public static int competition_isarchwayenabled = -1;

	public static int competition_isarchwayenabledstage = -1;

	public static int competition_isballplinthenabled = -1;

	public static int competition_isballplinthenabledstage = -1;

	public static int competition_isbannerenabled = -1;

	public static int competition_iscenterpitchflagenabled = -1;

	public static int competition_iscenterpitchflagenabledstage = -1;

	public static int competition_iscompetitioncrowdcardsenabled = -1;

	public static int competition_iscompetitionpodiumenabled = -1;

	public static int competition_iscompetitionpoleflagenabled = -1;

	public static int competition_iscompetitionscarfenabled = -1;

	public static int competition_isflamethrowercannonsenabled = -1;

	public static int competition_isflamethrowercannonsenabledstage = -1;

	public static int competition_isgoallinetechcompenabled = -1;

	public static int competition_isgoallinetechcompenabledstage = -1;

	public static int competition_isgoallinetechhomeleagueenabled = -1;

	public static int competition_isgoalnetadsenabledstage = -1;

	public static int competition_isinjuryboardenabled = -1;

	public static int competition_isintroconfettienabledstage = -1;

	public static int competition_ispitchtarpsenabledstage = -1;

	public static int competition_isstadiumdressingenabled = -1;

	public static int competition_isstadiumdressingenabledstage = -1;

	public static int competition_isstadiumdressingunique = -1;

	public static int competition_isstadiumdressinguniquestage = -1;

	public static int competition_isstanchionflamethrowerenabledstage = -1;

	public static int competition_isteampitchflagenabled = -1;

	public static int competition_isteampitchflagenabledstage = -1;

	public static int competition_isuniqueadboardscompenabled = -1;

	public static int competition_isuniquehandshakeboardenabled = -1;

	public static int competition_isuniqueleagueflagenabled = -1;

	public static int competition_isuniquetrophypedestalenabled = -1;

	public static int competition_isvanishingsprayenabled = -1;

	public static int competition_isvanishingsprayhomeenabled = -1;

	public static int competition_languageregion = -1;

	public static int competition_onpitchgraphics = -1;

	public static int competition_pitchtarps = -1;

	public static int competition_replay360degree = -1;

	public static int competition_stadiumcrowdmap = -1;

	public static int competition_stanchionflamethrower = -1;
	...
	public static void InitFI(DbFile fifaDb)
	{
		language_hashid = 0;
		language_stringid = 1;
		language_sourcetext = 0;
		Table table = fifaDb.GetTable("teamstadiumlinks");
		if (table != null)
		{
			teamstadiumlinks_stadiumid = table.TableDescriptor.GetFieldIndex("stadiumid");
			teamstadiumlinks_teamid = table.TableDescriptor.GetFieldIndex("teamid");
		}
		Table table2 = fifaDb.GetTable("teams");
		if (table2 != null)
		{
			teams_adboardid = table2.TableDescriptor.GetFieldIndex("adboardid");
			...
			teams_buspassing = table2.TableDescriptor.GetFieldIndex("buspassing");
			teams_buspositioning = table2.TableDescriptor.GetFieldIndex("buspositioning");
			teams_captainid = table2.TableDescriptor.GetFieldIndex("captainid");
			teams_cccrossing = table2.TableDescriptor.GetFieldIndex("cccrossing");
			teams_ccpassing = table2.TableDescriptor.GetFieldIndex("ccpassing");
			teams_ccpositioning = table2.TableDescriptor.GetFieldIndex("ccpositioning");
			teams_ccshooting = table2.TableDescriptor.GetFieldIndex("ccshooting");
			teams_cityid = table2.TableDescriptor.GetFieldIndex("cityid");
			...
			teams_defteamwidth = table2.TableDescriptor.GetFieldIndex("defteamwidth");
			...
			teams_genericbanner = table2.TableDescriptor.GetFieldIndex("genericbanner");
			teams_genericint1 = table2.TableDescriptor.GetFieldIndex("genericint1");
			...
			teams_latitude = table2.TableDescriptor.GetFieldIndex("latitude");
			teams_leaguetitles = table2.TableDescriptor.GetFieldIndex("leaguetitles");
			teams_leftcornerkicktakerid = table2.TableDescriptor.GetFieldIndex("leftcornerkicktakerid");
			teams_leftfreekicktakerid = table2.TableDescriptor.GetFieldIndex("leftfreekicktakerid");
			teams_longitude = table2.TableDescriptor.GetFieldIndex("longitude");
			teams_longkicktakerid = table2.TableDescriptor.GetFieldIndex("longkicktakerid");
			teams_matchdayattackrating = table2.TableDescriptor.GetFieldIndex("matchdayattackrating");
			teams_matchdaydefenserating = table2.TableDescriptor.GetFieldIndex("matchdaydefenserating");
			teams_matchdaymidfieldrating = table2.TableDescriptor.GetFieldIndex("matchdaymidfieldrating");
			teams_matchdayoverallrating = table2.TableDescriptor.GetFieldIndex("matchdayoverallrating");
			teams_midfieldrating = table2.TableDescriptor.GetFieldIndex("midfieldrating");
			teams_numtransfersin = table2.TableDescriptor.GetFieldIndex("numtransfersin");
			teams_opponentstrongthreshold = table2.TableDescriptor.GetFieldIndex("opponentstrongthreshold");
			teams_opponentweakthreshold = table2.TableDescriptor.GetFieldIndex("opponentweakthreshold");
			teams_overallrating = table2.TableDescriptor.GetFieldIndex("overallrating");
			teams_penaltytakerid = table2.TableDescriptor.GetFieldIndex("penaltytakerid");
			teams_personalityid = table2.TableDescriptor.GetFieldIndex("personalityid");
			teams_popularity = table2.TableDescriptor.GetFieldIndex("popularity");
			teams_powid = table2.TableDescriptor.GetFieldIndex("powid");
			teams_profitability = table2.TableDescriptor.GetFieldIndex("profitability");
			teams_rightcornerkicktakerid = table2.TableDescriptor.GetFieldIndex("rightcornerkicktakerid");
			teams_rightfreekicktakerid = table2.TableDescriptor.GetFieldIndex("rightfreekicktakerid");
			teams_rivalteam = table2.TableDescriptor.GetFieldIndex("rivalteam");
			teams_skinnyflags = table2.TableDescriptor.GetFieldIndex("skinnyflags");
			teams_stanchionflamethrower = table2.TableDescriptor.GetFieldIndex("stanchionflamethrower");
			teams_suittypeid = table2.TableDescriptor.GetFieldIndex("suittypeid");
			teams_suitvariationid = table2.TableDescriptor.GetFieldIndex("suitvariationid");
			teams_teamcolor1b = table2.TableDescriptor.GetFieldIndex("teamcolor1b");
			teams_teamcolor1g = table2.TableDescriptor.GetFieldIndex("teamcolor1g");
			teams_teamcolor1r = table2.TableDescriptor.GetFieldIndex("teamcolor1r");
			teams_teamcolor2b = table2.TableDescriptor.GetFieldIndex("teamcolor2b");
			teams_teamcolor2g = table2.TableDescriptor.GetFieldIndex("teamcolor2g");
			teams_teamcolor2r = table2.TableDescriptor.GetFieldIndex("teamcolor2r");
			teams_teamcolor3b = table2.TableDescriptor.GetFieldIndex("teamcolor3b");
			teams_teamcolor3g = table2.TableDescriptor.GetFieldIndex("teamcolor3g");
			teams_teamcolor3r = table2.TableDescriptor.GetFieldIndex("teamcolor3r");
			teams_teamid = table2.TableDescriptor.GetFieldIndex("teamid");
			teams_teamname = table2.TableDescriptor.GetFieldIndex("teamname");
			teams_teamstadiumcapacity = table2.TableDescriptor.GetFieldIndex("teamstadiumcapacity");
			teams_trainingstadium = table2.TableDescriptor.GetFieldIndex("trainingstadium");
			teams_trait1vequal = table2.TableDescriptor.GetFieldIndex("trait1vequal");
			teams_trait1vstrong = table2.TableDescriptor.GetFieldIndex("trait1vstrong");
			teams_trait1vweak = table2.TableDescriptor.GetFieldIndex("trait1vweak");
			teams_transferbudget = table2.TableDescriptor.GetFieldIndex("transferbudget");
			teams_utcoffset = table2.TableDescriptor.GetFieldIndex("utcoffset");
			teams_youthdevelopment = table2.TableDescriptor.GetFieldIndex("youthdevelopment");
			teams_fancrowdhairskintexturecode = table2.TableDescriptor.GetFieldIndex("fancrowdhairskintexturecode");
			teams_stafftracksuitcolorcode = table2.TableDescriptor.GetFieldIndex("stafftracksuitcolorcode");
			teams_physioid_primary = table2.TableDescriptor.GetFieldIndex("physioid_primary");
			teams_physioid_secondary = table2.TableDescriptor.GetFieldIndex("physioid_secondary");
			teams_trait1 = table2.TableDescriptor.GetFieldIndex("trait1");
		}
		Table table3 = fifaDb.GetTable("teamplayerlinks");
		if (table3 != null)
		{
			teamplayerlinks_artificialkey = table3.TableDescriptor.GetFieldIndex("artificialkey");
			teamplayerlinks_form = table3.TableDescriptor.GetFieldIndex("form");
			teamplayerlinks_prevform = table3.TableDescriptor.GetFieldIndex("prevform");
			teamplayerlinks_injury = table3.TableDescriptor.GetFieldIndex("injury");
			teamplayerlinks_isamongtopscorers = table3.TableDescriptor.GetFieldIndex("isamongtopscorers");
			teamplayerlinks_isamongtopscorersinteam = table3.TableDescriptor.GetFieldIndex("isamongtopscorersinteam");
			teamplayerlinks_istopscorer = table3.TableDescriptor.GetFieldIndex("istopscorer");
			teamplayerlinks_jerseynumber = table3.TableDescriptor.GetFieldIndex("jerseynumber");
			teamplayerlinks_leagueappearances = table3.TableDescriptor.GetFieldIndex("leagueappearances");
			teamplayerlinks_leaguegoals = table3.TableDescriptor.GetFieldIndex("leaguegoals");
			teamplayerlinks_leaguegoalsprevmatch = table3.TableDescriptor.GetFieldIndex("leaguegoalsprevmatch");
			teamplayerlinks_leaguegoalsprevthreematches = table3.TableDescriptor.GetFieldIndex("leaguegoalsprevthreematches");
			teamplayerlinks_playerid = table3.TableDescriptor.GetFieldIndex("playerid");
			teamplayerlinks_position = table3.TableDescriptor.GetFieldIndex("position");
			teamplayerlinks_reds = table3.TableDescriptor.GetFieldIndex("reds");
			teamplayerlinks_teamid = table3.TableDescriptor.GetFieldIndex("teamid");
			teamplayerlinks_yellows = table3.TableDescriptor.GetFieldIndex("yellows");
		}
		Table table4 = fifaDb.GetTable("teamformationteamstylelinks");
		if (table4 != null)
		{
			teamformationteamstylelinks_cddl = table4.TableDescriptor.GetFieldIndex("cddl");
			teamformationteamstylelinks_formationid = table4.TableDescriptor.GetFieldIndex("formationid");
			teamformationteamstylelinks_teamid = table4.TableDescriptor.GetFieldIndex("teamid");
			teamformationteamstylelinks_teamstyleid = table4.TableDescriptor.GetFieldIndex("teamstyleid");
		}
		Table table5 = fifaDb.GetTable("teamkits");
		if (table5 != null)
		{
			teamkits_dlc = table5.TableDescriptor.GetFieldIndex("dlc");
			teamkits_hasadvertisingkit = table5.TableDescriptor.GetFieldIndex("hasadvertisingkit");
			teamkits_isembargoed = table5.TableDescriptor.GetFieldIndex("isembargoed");
			teamkits_isinheritbasedetailmap = table5.TableDescriptor.GetFieldIndex("isinheritbasedetailmap");
			teamkits_islocked = table5.TableDescriptor.GetFieldIndex("islocked");
			teamkits_jerseybacknamefontcase = table5.TableDescriptor.GetFieldIndex("jerseybacknamefontcase");
			teamkits_jerseybacknameplacementcode = table5.TableDescriptor.GetFieldIndex("jerseybacknameplacementcode");
			teamkits_jerseycollargeometrytype = table5.TableDescriptor.GetFieldIndex("jerseycollargeometrytype");
			teamkits_jerseyfit = table5.TableDescriptor.GetFieldIndex("jerseyfit");
			teamkits_jerseyfrontnumberplacementcode = table5.TableDescriptor.GetFieldIndex("jerseyfrontnumberplacementcode");
			teamkits_jerseynamecolorb = table5.TableDescriptor.GetFieldIndex("jerseynamecolorb");
			teamkits_jerseynamecolorg = table5.TableDescriptor.GetFieldIndex("jerseynamecolorg");
			teamkits_jerseynamecolorr = table5.TableDescriptor.GetFieldIndex("jerseynamecolorr");
			teamkits_jerseynamefonttype = table5.TableDescriptor.GetFieldIndex("jerseynamefonttype");
			teamkits_jerseynamelayouttype = table5.TableDescriptor.GetFieldIndex("jerseynamelayouttype");
			teamkits_jerseynumbercolorprimb = table5.TableDescriptor.GetFieldIndex("jerseynumbercolorprimb");
			teamkits_jerseynumbercolorprimg = table5.TableDescriptor.GetFieldIndex("jerseynumbercolorprimg");
			teamkits_jerseynumbercolorprimr = table5.TableDescriptor.GetFieldIndex("jerseynumbercolorprimr");
			teamkits_jerseynumbercolorsecb = table5.TableDescriptor.GetFieldIndex("jerseynumbercolorsecb");
			teamkits_jerseynumbercolorsecg = table5.TableDescriptor.GetFieldIndex("jerseynumbercolorsecg");
			teamkits_jerseynumbercolorsecr = table5.TableDescriptor.GetFieldIndex("jerseynumbercolorsecr");
			teamkits_jerseynumbercolorterb = table5.TableDescriptor.GetFieldIndex("jerseynumbercolorterb");
			teamkits_jerseynumbercolorterg = table5.TableDescriptor.GetFieldIndex("jerseynumbercolorterg");
			teamkits_jerseynumbercolorterr = table5.TableDescriptor.GetFieldIndex("jerseynumbercolorterr");
			teamkits_jerseyrenderingdetailmaptype = table5.TableDescriptor.GetFieldIndex("jerseyrenderingdetailmaptype");
			teamkits_jerseyshapestyle = table5.TableDescriptor.GetFieldIndex("jerseyshapestyle");
			teamkits_numberfonttype = table5.TableDescriptor.GetFieldIndex("numberfonttype");
			teamkits_numbercolor = table5.TableDescriptor.GetFieldIndex("numbercolor");
			teamkits_powid = table5.TableDescriptor.GetFieldIndex("powid");
			teamkits_renderingmaterialtype = table5.TableDescriptor.GetFieldIndex("renderingmaterialtype");
			teamkits_shortsnumbercolorprimb = table5.TableDescriptor.GetFieldIndex("shortsnumbercolorprimb");
			teamkits_shortsnumbercolorprimg = table5.TableDescriptor.GetFieldIndex("shortsnumbercolorprimg");
			teamkits_shortsnumbercolorprimr = table5.TableDescriptor.GetFieldIndex("shortsnumbercolorprimr");
			teamkits_shortsnumbercolorsecb = table5.TableDescriptor.GetFieldIndex("shortsnumbercolorsecb");
			teamkits_shortsnumbercolorsecg = table5.TableDescriptor.GetFieldIndex("shortsnumbercolorsecg");
			teamkits_shortsnumbercolorsecr = table5.TableDescriptor.GetFieldIndex("shortsnumbercolorsecr");
			teamkits_shortsnumbercolorterb = table5.TableDescriptor.GetFieldIndex("shortsnumbercolorterb");
			teamkits_shortsnumbercolorterg = table5.TableDescriptor.GetFieldIndex("shortsnumbercolorterg");
			teamkits_shortsnumbercolorterr = table5.TableDescriptor.GetFieldIndex("shortsnumbercolorterr");
			teamkits_shortsnumberfonttype = table5.TableDescriptor.GetFieldIndex("shortsnumberfonttype");
			teamkits_shortsnumbercolor = table5.TableDescriptor.GetFieldIndex("shortsnumbercolor");
			teamkits_shortsnumberplacementcode = table5.TableDescriptor.GetFieldIndex("shortsnumberplacementcode");
			teamkits_shortsrenderingdetailmaptype = table5.TableDescriptor.GetFieldIndex("shortsrenderingdetailmaptype");
			teamkits_shortstyle = table5.TableDescriptor.GetFieldIndex("shortstyle");
			teamkits_teamcolorprimb = table5.TableDescriptor.GetFieldIndex("teamcolorprimb");
			teamkits_teamcolorprimg = table5.TableDescriptor.GetFieldIndex("teamcolorprimg");
			teamkits_teamcolorprimpercent = table5.TableDescriptor.GetFieldIndex("teamcolorprimpercent");
			teamkits_teamcolorprimr = table5.TableDescriptor.GetFieldIndex("teamcolorprimr");
			teamkits_teamcolorsecb = table5.TableDescriptor.GetFieldIndex("teamcolorsecb");
			teamkits_teamcolorsecg = table5.TableDescriptor.GetFieldIndex("teamcolorsecg");
			teamkits_teamcolorsecpercent = table5.TableDescriptor.GetFieldIndex("teamcolorsecpercent");
			teamkits_teamcolorsecr = table5.TableDescriptor.GetFieldIndex("teamcolorsecr");
			teamkits_teamcolortertb = table5.TableDescriptor.GetFieldIndex("teamcolortertb");
			teamkits_teamcolortertg = table5.TableDescriptor.GetFieldIndex("teamcolortertg");
			teamkits_teamcolortertpercent = table5.TableDescriptor.GetFieldIndex("teamcolortertpercent");
			teamkits_teamcolortertr = table5.TableDescriptor.GetFieldIndex("teamcolortertr");
			teamkits_teamkitid = table5.TableDescriptor.GetFieldIndex("teamkitid");
			teamkits_teamkittypetechid = table5.TableDescriptor.GetFieldIndex("teamkittypetechid");
			teamkits_teamtechid = table5.TableDescriptor.GetFieldIndex("teamtechid");
			teamkits_year = table5.TableDescriptor.GetFieldIndex("year");
		}
		Table table6 = fifaDb.GetTable("teamballs");
		if (table6 != null)
		{
			teamballs_ballid = table6.TableDescriptor.GetFieldIndex("ballid");
			teamballs_powid = table6.TableDescriptor.GetFieldIndex("powid");
			teamballs_islicensed = table6.TableDescriptor.GetFieldIndex("islicensed");
			teamballs_isembargoed = table6.TableDescriptor.GetFieldIndex("isembargoed");
			teamballs_isavailableinstore = table6.TableDescriptor.GetFieldIndex("isavailableinstore");
		}
		Table table7 = fifaDb.GetTable("playerboots");
		if (table7 != null)
		{
			playerboots_isadidas = table7.TableDescriptor.GetFieldIndex("isadidas");
			playerboots_isavailableinstore = table7.TableDescriptor.GetFieldIndex("isavailableinstore");
			playerboots_isembargoed = table7.TableDescriptor.GetFieldIndex("isembargoed");
			playerboots_gender = table7.TableDescriptor.GetFieldIndex("gender");
			playerboots_islegacy = table7.TableDescriptor.GetFieldIndex("islegacy");
			playerboots_islicensed = table7.TableDescriptor.GetFieldIndex("islicensed");
			playerboots_islocked = table7.TableDescriptor.GetFieldIndex("islocked");
			playerboots_powid = table7.TableDescriptor.GetFieldIndex("powid");
			playerboots_shoecolor1 = table7.TableDescriptor.GetFieldIndex("shoecolor1");
			playerboots_shoecolor2 = table7.TableDescriptor.GetFieldIndex("shoecolor2");
			playerboots_shoedesign = table7.TableDescriptor.GetFieldIndex("shoedesign");
			playerboots_shoetype = table7.TableDescriptor.GetFieldIndex("shoetype");
		}
		Table table8 = fifaDb.GetTable("stadiums");
		if (table8 != null)
		{
			stadiums_adboardendlinedistance = table8.TableDescriptor.GetFieldIndex("adboardendlinedistance");
			stadiums_adboardsidelinedistance = table8.TableDescriptor.GetFieldIndex("adboardsidelinedistance");
			stadiums_adboardtype = table8.TableDescriptor.GetFieldIndex("adboardtype");
			stadiums_cameraheight = table8.TableDescriptor.GetFieldIndex("cameraheight");
			stadiums_camerazoom = table8.TableDescriptor.GetFieldIndex("camerazoom");
			stadiums_capacity = table8.TableDescriptor.GetFieldIndex("capacity");
			stadiums_cityid = table8.TableDescriptor.GetFieldIndex("cityid");
			stadiums_colorregion = table8.TableDescriptor.GetFieldIndex("colorregion");
			stadiums_countrycode = table8.TableDescriptor.GetFieldIndex("countrycode");
			stadiums_defaultseason = table8.TableDescriptor.GetFieldIndex("defaultseason");
			stadiums_defaulttime = table8.TableDescriptor.GetFieldIndex("defaulttime");
			stadiums_defaultweather = table8.TableDescriptor.GetFieldIndex("defaultweather");
			stadiums_dlc = table8.TableDescriptor.GetFieldIndex("dlc");
			stadiums_genericrank = table8.TableDescriptor.GetFieldIndex("genericrank");
			stadiums_gmavailability = table8.TableDescriptor.GetFieldIndex("gmavailability");
			stadiums_goalnetads = table8.TableDescriptor.GetFieldIndex("goalnetads");
			stadiums_goalnetstanchioncolor1b = table8.TableDescriptor.GetFieldIndex("goalnetstanchioncolor1b");
			stadiums_goalnetstanchioncolor1g = table8.TableDescriptor.GetFieldIndex("goalnetstanchioncolor1g");
			stadiums_goalnetstanchioncolor1r = table8.TableDescriptor.GetFieldIndex("goalnetstanchioncolor1r");
			stadiums_goalnetstanchioncolor2b = table8.TableDescriptor.GetFieldIndex("goalnetstanchioncolor2b");
			stadiums_goalnetstanchioncolor2g = table8.TableDescriptor.GetFieldIndex("goalnetstanchioncolor2g");
			stadiums_goalnetstanchioncolor2r = table8.TableDescriptor.GetFieldIndex("goalnetstanchioncolor2r");
			stadiums_hometeamid = table8.TableDescriptor.GetFieldIndex("hometeamid");
			stadiums_inflatables = table8.TableDescriptor.GetFieldIndex("inflatables");
			stadiums_isdynamic = table8.TableDescriptor.GetFieldIndex("isdynamic");
			stadiums_iseditable = table8.TableDescriptor.GetFieldIndex("iseditable");
			stadiums_islicensed = table8.TableDescriptor.GetFieldIndex("islicensed");
			stadiums_isstadiumavailable = table8.TableDescriptor.GetFieldIndex("isstadiumavailable");
			stadiums_languageregion = table8.TableDescriptor.GetFieldIndex("languageregion");
			stadiums_name = table8.TableDescriptor.GetFieldIndex("name");
			stadiums_pitchtarps = table8.TableDescriptor.GetFieldIndex("pitchtarps");
			stadiums_policetypecode = table8.TableDescriptor.GetFieldIndex("policetypecode");
			stadiums_replay360degree = table8.TableDescriptor.GetFieldIndex("replay360degree");
			stadiums_rotation360degree = table8.TableDescriptor.GetFieldIndex("rotation360degree");
			stadiums_seatcolor = table8.TableDescriptor.GetFieldIndex("seatcolor");
			stadiums_sectionfacedbydefault = table8.TableDescriptor.GetFieldIndex("sectionfacedbydefault");
			stadiums_stadawaytechzonemaxx = table8.TableDescriptor.GetFieldIndex("stadawaytechzonemaxx");
			stadiums_stadawaytechzonemaxz = table8.TableDescriptor.GetFieldIndex("stadawaytechzonemaxz");
			stadiums_stadawaytechzoneminx = table8.TableDescriptor.GetFieldIndex("stadawaytechzoneminx");
			stadiums_stadawaytechzoneminz = table8.TableDescriptor.GetFieldIndex("stadawaytechzoneminz");
			stadiums_stadhometechzonemaxx = table8.TableDescriptor.GetFieldIndex("stadhometechzonemaxx");
			stadiums_stadhometechzonemaxz = table8.TableDescriptor.GetFieldIndex("stadhometechzonemaxz");
			stadiums_stadhometechzoneminx = table8.TableDescriptor.GetFieldIndex("stadhometechzoneminx");
			stadiums_stadhometechzoneminz = table8.TableDescriptor.GetFieldIndex("stadhometechzoneminz");
			stadiums_stadiumgloalnetdepth = table8.TableDescriptor.GetFieldIndex("stadiumgloalnetdepth");
			stadiums_stadiumgoalnetlength = table8.TableDescriptor.GetFieldIndex("stadiumgoalnetlength");
			stadiums_stadiumgoalnetpattern = table8.TableDescriptor.GetFieldIndex("stadiumgoalnetpattern");
			stadiums_stadiumgoalnetstyle = table8.TableDescriptor.GetFieldIndex("stadiumgoalnetstyle");
			stadiums_stadiumgoalnettension = table8.TableDescriptor.GetFieldIndex("stadiumgoalnettension");
			stadiums_stadiumgoalnettype = table8.TableDescriptor.GetFieldIndex("stadiumgoalnettype");
			stadiums_stadiumgoalnetwidth = table8.TableDescriptor.GetFieldIndex("stadiumgoalnetwidth");
			stadiums_stadiumid = table8.TableDescriptor.GetFieldIndex("stadiumid");
			stadiums_stadiummowpattern_code = table8.TableDescriptor.GetFieldIndex("stadiummowpattern_code");
			stadiums_stadiumpitchlength = table8.TableDescriptor.GetFieldIndex("stadiumpitchlength");
			stadiums_stadiumpitchwidth = table8.TableDescriptor.GetFieldIndex("stadiumpitchwidth");
			stadiums_stadiumtype = table8.TableDescriptor.GetFieldIndex("stadiumtype");
			stadiums_timeofday1 = table8.TableDescriptor.GetFieldIndex("timeofday1");
			stadiums_timeofday2 = table8.TableDescriptor.GetFieldIndex("timeofday2");
			stadiums_timeofday3 = table8.TableDescriptor.GetFieldIndex("timeofday3");
			stadiums_timeofday4 = table8.TableDescriptor.GetFieldIndex("timeofday4");
			stadiums_tod1weather = table8.TableDescriptor.GetFieldIndex("tod1weather");
			stadiums_tod2weather = table8.TableDescriptor.GetFieldIndex("tod2weather");
			stadiums_tod3weather = table8.TableDescriptor.GetFieldIndex("tod3weather");
			stadiums_tod4weather = table8.TableDescriptor.GetFieldIndex("tod4weather");
			stadiums_upgradestyle = table8.TableDescriptor.GetFieldIndex("upgradestyle");
			stadiums_upgradetier = table8.TableDescriptor.GetFieldIndex("upgradetier");
			stadiums_yearbuilt = table8.TableDescriptor.GetFieldIndex("yearbuilt");
		}
		Table table9 = fifaDb.GetTable("shoecolors");
		if (table9 != null)
		{
			shoecolors_blue = table9.TableDescriptor.GetFieldIndex("blue");
			shoecolors_green = table9.TableDescriptor.GetFieldIndex("green");
			shoecolors_red = table9.TableDescriptor.GetFieldIndex("red");
			shoecolors_colorid = table9.TableDescriptor.GetFieldIndex("colorid");
		}
		Table table10 = fifaDb.GetTable("rowteamnationlinks");
		if (table10 != null)
		{
			rowteamnationlinks_nationid = table10.TableDescriptor.GetFieldIndex("nationid");
			rowteamnationlinks_teamid = table10.TableDescriptor.GetFieldIndex("teamid");
		}
		Table table11 = fifaDb.GetTable("rivals");
		if (table11 != null)
		{
			rivals_rivaltype = table11.TableDescriptor.GetFieldIndex("rivaltype");
			rivals_teamid2 = table11.TableDescriptor.GetFieldIndex("teamid2");
			rivals_teamid1 = table11.TableDescriptor.GetFieldIndex("teamid1");
		}
		Table table12 = fifaDb.GetTable("referee");
		if (table12 != null)
		{
			referee_birthdate = table12.TableDescriptor.GetFieldIndex("birthdate");
			referee_bodytypecode = table12.TableDescriptor.GetFieldIndex("bodytypecode");
			referee_cardstrictness = table12.TableDescriptor.GetFieldIndex("cardstrictness");
			referee_eyebrowcode = table12.TableDescriptor.GetFieldIndex("eyebrowcode");
			referee_eyecolorcode = table12.TableDescriptor.GetFieldIndex("eyecolorcode");
			referee_facialhaircolorcode = table12.TableDescriptor.GetFieldIndex("facialhaircolorcode");
			referee_facialhairtypecode = table12.TableDescriptor.GetFieldIndex("facialhairtypecode");
			referee_firstname = table12.TableDescriptor.GetFieldIndex("firstname");
			referee_foulstrictness = table12.TableDescriptor.GetFieldIndex("foulstrictness");
			referee_gender = table12.TableDescriptor.GetFieldIndex("gender");
			referee_haircolorcode = table12.TableDescriptor.GetFieldIndex("haircolorcode");
			referee_hairstylecode = table12.TableDescriptor.GetFieldIndex("hairstylecode");
			referee_hairtypecode = table12.TableDescriptor.GetFieldIndex("hairtypecode");
			referee_headclasscode = table12.TableDescriptor.GetFieldIndex("headclasscode");
			referee_headtypecode = table12.TableDescriptor.GetFieldIndex("headtypecode");
			referee_headvariation = table12.TableDescriptor.GetFieldIndex("headvariation");
			referee_height = table12.TableDescriptor.GetFieldIndex("height");
			referee_isreal = table12.TableDescriptor.GetFieldIndex("isreal");
			referee_jerseysleevelengthcode = table12.TableDescriptor.GetFieldIndex("jerseysleevelengthcode");
			referee_leagueid = table12.TableDescriptor.GetFieldIndex("leagueid");
			referee_nationalitycode = table12.TableDescriptor.GetFieldIndex("nationalitycode");
			referee_refereeid = table12.TableDescriptor.GetFieldIndex("refereeid");
			referee_shoecolorcode1 = table12.TableDescriptor.GetFieldIndex("shoecolorcode1");
			referee_shoecolorcode2 = table12.TableDescriptor.GetFieldIndex("shoecolorcode2");
			referee_shoedesigncode = table12.TableDescriptor.GetFieldIndex("shoedesigncode");
			referee_shoetypecode = table12.TableDescriptor.GetFieldIndex("shoetypecode");
			referee_shortstyle = table12.TableDescriptor.GetFieldIndex("shortstyle");
			referee_sideburnscode = table12.TableDescriptor.GetFieldIndex("sideburnscode");
			referee_skintonecode = table12.TableDescriptor.GetFieldIndex("skintonecode");
			referee_skintypecode = table12.TableDescriptor.GetFieldIndex("skintypecode");
			referee_sockheightcode = table12.TableDescriptor.GetFieldIndex("sockheightcode");
			referee_socklengthcode = table12.TableDescriptor.GetFieldIndex("socklengthcode");
			referee_stylecode = table12.TableDescriptor.GetFieldIndex("stylecode");
			referee_homecitycode = table12.TableDescriptor.GetFieldIndex("homecitycode");
			referee_haireffecttypecode = table12.TableDescriptor.GetFieldIndex("haireffecttypecode");
			referee_hairlinecode = table12.TableDescriptor.GetFieldIndex("hairlinecode");
			referee_hairpartcode = table12.TableDescriptor.GetFieldIndex("hairpartcode");
			referee_hairstateid = table12.TableDescriptor.GetFieldIndex("hairstateid");
			referee_hairvariationid = table12.TableDescriptor.GetFieldIndex("hairvariationid");
			referee_sweatid = table12.TableDescriptor.GetFieldIndex("sweatid");
			referee_wrinkleid = table12.TableDescriptor.GetFieldIndex("wrinkleid");
			referee_proxyhaircolorid = table12.TableDescriptor.GetFieldIndex("proxyhaircolorid");
			referee_proxyheadclass = table12.TableDescriptor.GetFieldIndex("proxyheadclass");
			referee_surname = table12.TableDescriptor.GetFieldIndex("surname");
			referee_weight = table12.TableDescriptor.GetFieldIndex("weight");
		}
		Table table13 = fifaDb.GetTable("previousteam");
		if (table13 != null)
		{
			previousteam_previousteamid = table13.TableDescriptor.GetFieldIndex("previousteamid");
			previousteam_playerid = table13.TableDescriptor.GetFieldIndex("playerid");
		}
		Table table14 = fifaDb.GetTable("players");
		if (table14 != null)
		{
			players_acceleration = table14.TableDescriptor.GetFieldIndex("acceleration");
			players_accessorycode1 = table14.TableDescriptor.GetFieldIndex("accessorycode1");
			players_accessorycode2 = table14.TableDescriptor.GetFieldIndex("accessorycode2");
			players_accessorycode3 = table14.TableDescriptor.GetFieldIndex("accessorycode3");
			players_accessorycode4 = table14.TableDescriptor.GetFieldIndex("accessorycode4");
			players_accessorycolourcode1 = table14.TableDescriptor.GetFieldIndex("accessorycolourcode1");
			players_accessorycolourcode2 = table14.TableDescriptor.GetFieldIndex("accessorycolourcode2");
			players_accessorycolourcode3 = table14.TableDescriptor.GetFieldIndex("accessorycolourcode3");
			players_accessorycolourcode4 = table14.TableDescriptor.GetFieldIndex("accessorycolourcode4");
			players_aggression = table14.TableDescriptor.GetFieldIndex("aggression");
			players_agility = table14.TableDescriptor.GetFieldIndex("agility");
			players_animfreekickstartposcode = table14.TableDescriptor.GetFieldIndex("animfreekickstartposcode");
			players_animpenaltiesapproachcode = table14.TableDescriptor.GetFieldIndex("animpenaltiesapproachcode");
			players_animpenaltieskickstylecode = table14.TableDescriptor.GetFieldIndex("animpenaltieskickstylecode");
			players_animpenaltiesmotionstylecode = table14.TableDescriptor.GetFieldIndex("animpenaltiesmotionstylecode");
			players_animpenaltiesstartposcode = table14.TableDescriptor.GetFieldIndex("animpenaltiesstartposcode");
			players_attackingworkrate = table14.TableDescriptor.GetFieldIndex("attackingworkrate");
			players_balance = table14.TableDescriptor.GetFieldIndex("balance");
			players_ballcontrol = table14.TableDescriptor.GetFieldIndex("ballcontrol");
			players_birthdate = table14.TableDescriptor.GetFieldIndex("birthdate");
			players_bodytypecode = table14.TableDescriptor.GetFieldIndex("bodytypecode");
			players_commonnameid = table14.TableDescriptor.GetFieldIndex("commonnameid");
			players_composure = table14.TableDescriptor.GetFieldIndex("composure");
			players_contractvaliduntil = table14.TableDescriptor.GetFieldIndex("contractvaliduntil");
			players_crossing = table14.TableDescriptor.GetFieldIndex("crossing");
			players_curve = table14.TableDescriptor.GetFieldIndex("curve");
			players_defensiveworkrate = table14.TableDescriptor.GetFieldIndex("defensiveworkrate");
			players_dribbling = table14.TableDescriptor.GetFieldIndex("dribbling");
			players_emotion = table14.TableDescriptor.GetFieldIndex("emotion");
			players_eyebrowcode = table14.TableDescriptor.GetFieldIndex("eyebrowcode");
			players_eyecolorcode = table14.TableDescriptor.GetFieldIndex("eyecolorcode");
			players_faceposercode = table14.TableDescriptor.GetFieldIndex("faceposercode");
			players_facialhaircolorcode = table14.TableDescriptor.GetFieldIndex("facialhaircolorcode");
			players_facialhairtypecode = table14.TableDescriptor.GetFieldIndex("facialhairtypecode");
			players_finishing = table14.TableDescriptor.GetFieldIndex("finishing");
			players_finishingcode1 = table14.TableDescriptor.GetFieldIndex("finishingcode1");
			players_finishingcode2 = table14.TableDescriptor.GetFieldIndex("finishingcode2");
			players_firstnameid = table14.TableDescriptor.GetFieldIndex("firstnameid");
			players_freekickaccuracy = table14.TableDescriptor.GetFieldIndex("freekickaccuracy");
			players_gender = table14.TableDescriptor.GetFieldIndex("gender");
			players_gkdiving = table14.TableDescriptor.GetFieldIndex("gkdiving");
			players_gkglovetypecode = table14.TableDescriptor.GetFieldIndex("gkglovetypecode");
			players_gkhandling = table14.TableDescriptor.GetFieldIndex("gkhandling");
			players_gkkicking = table14.TableDescriptor.GetFieldIndex("gkkicking");
			players_gkkickstyle = table14.TableDescriptor.GetFieldIndex("gkkickstyle");
			players_gkpositioning = table14.TableDescriptor.GetFieldIndex("gkpositioning");
			players_gkreflexes = table14.TableDescriptor.GetFieldIndex("gkreflexes");
			players_gksavetype = table14.TableDescriptor.GetFieldIndex("gksavetype");
			players_haircolorcode = table14.TableDescriptor.GetFieldIndex("haircolorcode");
			players_hairstylecode = table14.TableDescriptor.GetFieldIndex("hairstylecode");
			players_hairtypecode = table14.TableDescriptor.GetFieldIndex("hairtypecode");
			players_hashighqualityhead = table14.TableDescriptor.GetFieldIndex("hashighqualityhead");
			players_hasseasonaljersey = table14.TableDescriptor.GetFieldIndex("hasseasonaljersey");
			players_headclasscode = table14.TableDescriptor.GetFieldIndex("headclasscode");
			players_headingaccuracy = table14.TableDescriptor.GetFieldIndex("headingaccuracy");
			players_headtypecode = table14.TableDescriptor.GetFieldIndex("headtypecode");
			players_headvariation = table14.TableDescriptor.GetFieldIndex("headvariation");
			players_height = table14.TableDescriptor.GetFieldIndex("height");
			players_interceptions = table14.TableDescriptor.GetFieldIndex("interceptions");
			players_internationalrep = table14.TableDescriptor.GetFieldIndex("internationalrep");
			players_iscustomized = table14.TableDescriptor.GetFieldIndex("iscustomized");
			players_isretiring = table14.TableDescriptor.GetFieldIndex("isretiring");
			players_jerseyfit = table14.TableDescriptor.GetFieldIndex("jerseyfit");
			players_jerseysleevelengthcode = table14.TableDescriptor.GetFieldIndex("jerseysleevelengthcode");
			players_jerseystylecode = table14.TableDescriptor.GetFieldIndex("jerseystylecode");
			players_jumping = table14.TableDescriptor.GetFieldIndex("jumping");
			players_lastnameid = table14.TableDescriptor.GetFieldIndex("lastnameid");
			players_longpassing = table14.TableDescriptor.GetFieldIndex("longpassing");
			players_longshots = table14.TableDescriptor.GetFieldIndex("longshots");
			players_marking = table14.TableDescriptor.GetFieldIndex("marking");
			players_modifier = table14.TableDescriptor.GetFieldIndex("modifier");
			players_nationality = table14.TableDescriptor.GetFieldIndex("nationality");
			players_overallrating = table14.TableDescriptor.GetFieldIndex("overallrating");
			players_penalties = table14.TableDescriptor.GetFieldIndex("penalties");
			players_playerid = table14.TableDescriptor.GetFieldIndex("playerid");
			players_playerjerseynameid = table14.TableDescriptor.GetFieldIndex("playerjerseynameid");
			players_playerjointeamdate = table14.TableDescriptor.GetFieldIndex("playerjointeamdate");
			players_positioning = table14.TableDescriptor.GetFieldIndex("positioning");
			players_potential = table14.TableDescriptor.GetFieldIndex("potential");
			players_preferredfoot = table14.TableDescriptor.GetFieldIndex("preferredfoot");
			players_preferredposition1 = table14.TableDescriptor.GetFieldIndex("preferredposition1");
			players_preferredposition2 = table14.TableDescriptor.GetFieldIndex("preferredposition2");
			...
			players_shoecolorcode2 = table14.TableDescriptor.GetFieldIndex("shoecolorcode2");
			players_shoedesigncode = table14.TableDescriptor.GetFieldIndex("shoedesigncode");
			players_shoetypecode = table14.TableDescriptor.GetFieldIndex("shoetypecode");
			players_shortpassing = table14.TableDescriptor.GetFieldIndex("shortpassing");
			players_shortstyle = table14.TableDescriptor.GetFieldIndex("shortstyle");
			players_shotpower = table14.TableDescriptor.GetFieldIndex("shotpower");
			players_sideburnscode = table14.TableDescriptor.GetFieldIndex("sideburnscode");
			players_skillmoves = table14.TableDescriptor.GetFieldIndex("skillmoves");
			players_skintonecode = table14.TableDescriptor.GetFieldIndex("skintonecode");
			players_skintypecode = table14.TableDescriptor.GetFieldIndex("skintypecode");
			players_slidingtackle = table14.TableDescriptor.GetFieldIndex("slidingtackle");
			players_socklengthcode = table14.TableDescriptor.GetFieldIndex("socklengthcode");
			players_sprintspeed = table14.TableDescriptor.GetFieldIndex("sprintspeed");
			players_stamina = table14.TableDescriptor.GetFieldIndex("stamina");
			players_standingtackle = table14.TableDescriptor.GetFieldIndex("standingtackle");
			players_strength = table14.TableDescriptor.GetFieldIndex("strength");
			players_tattoobackneck = table14.TableDescriptor.GetFieldIndex("tattoobackneck");
			players_tattooleftarm = table14.TableDescriptor.GetFieldIndex("tattooleftarm");
			players_tattooleftneck = table14.TableDescriptor.GetFieldIndex("tattooleftneck");
			players_tattoorightarm = table14.TableDescriptor.GetFieldIndex("tattoorightarm");
			players_tattoorightneck = table14.TableDescriptor.GetFieldIndex("tattoorightneck");
			players_trait1 = table14.TableDescriptor.GetFieldIndex("trait1");
			players_trait2 = table14.TableDescriptor.GetFieldIndex("trait2");
			players_usercaneditname = table14.TableDescriptor.GetFieldIndex("usercaneditname");
			players_vision = table14.TableDescriptor.GetFieldIndex("vision");
			players_volleys = table14.TableDescriptor.GetFieldIndex("volleys");
			players_weakfootabilitytypecode = table14.TableDescriptor.GetFieldIndex("weakfootabilitytypecode");
			players_weight = table14.TableDescriptor.GetFieldIndex("weight");
		}
		Table table15 = fifaDb.GetTable("career_presignedcontract");
		if (table15 != null)
		{
			career_presignedcontract_signdate = table15.TableDescriptor.GetFieldIndex("signeddate");
			career_presignedcontract_iscomingthisseason = table15.TableDescriptor.GetFieldIndex("iscomingthisseason");
			career_presignedcontract_offerteamid = table15.TableDescriptor.GetFieldIndex("offerteamid");
			career_presignedcontract_offerid = table15.TableDescriptor.GetFieldIndex("offerid");
			career_presignedcontract_future_fee = table15.TableDescriptor.GetFieldIndex("future_fee");
			career_presignedcontract_performancebonuscount = table15.TableDescriptor.GetFieldIndex("performancebonuscount");
			career_presignedcontract_exchangeplayerwage = table15.TableDescriptor.GetFieldIndex("exchangeplayerwage");
			career_presignedcontract_currentcontractwage = table15.TableDescriptor.GetFieldIndex("currentcontractwage");
			career_presignedcontract_exchangeplayerid = table15.TableDescriptor.GetFieldIndex("exchangeplayerid");
			career_presignedcontract_offeredfee = table15.TableDescriptor.GetFieldIndex("offeredfee");
			career_presignedcontract_offeredwage = table15.TableDescriptor.GetFieldIndex("offeredwage");
			career_presignedcontract_performancebonusvalue = table15.TableDescriptor.GetFieldIndex("performancebonusvalue");
			career_presignedcontract_performancebonustype = table15.TableDescriptor.GetFieldIndex("performancebonustype");
			career_presignedcontract_completedate = table15.TableDescriptor.GetFieldIndex("completedate");
			career_presignedcontract_isloanbuy = table15.TableDescriptor.GetFieldIndex("isloanbuy");
			career_presignedcontract_signonbonus = table15.TableDescriptor.GetFieldIndex("signonbonus");
			career_presignedcontract_teamid = table15.TableDescriptor.GetFieldIndex("teamid");
			career_presignedcontract_offeredcontracttype = table15.TableDescriptor.GetFieldIndex("offeredcontracttype");
			career_presignedcontract_releaseclause = table15.TableDescriptor.GetFieldIndex("releaseclause");
			career_presignedcontract_playerid = table15.TableDescriptor.GetFieldIndex("playerid");
			career_presignedcontract_squadrole = table15.TableDescriptor.GetFieldIndex("squadrole");
		}
		Table table16 = fifaDb.GetTable("playernames");
		if (table16 != null)
		{
			playernames_name = table16.TableDescriptor.GetFieldIndex("name");
			playernames_commentaryid = table16.TableDescriptor.GetFieldIndex("commentaryid");
			playernames_nameid = table16.TableDescriptor.GetFieldIndex("nameid");
		}
		Table table17 = fifaDb.GetTable("dcplayernames");
		if (table17 != null)
		{
			dcplayernames_name = table17.TableDescriptor.GetFieldIndex("name");
			dcplayernames_nameid = table17.TableDescriptor.GetFieldIndex("nameid");
		}
		Table table18 = fifaDb.GetTable("playerloans");
		if (table18 != null)
		{
			playerloans_loandateend = table18.TableDescriptor.GetFieldIndex("loandateend");
			playerloans_teamidloanedfrom = table18.TableDescriptor.GetFieldIndex("teamidloanedfrom");
			playerloans_playerid = table18.TableDescriptor.GetFieldIndex("playerid");
		}
		Table table19 = fifaDb.GetTable("player_grudgelove");
		if (table19 != null)
		{
			player_grudgelove_level_of_emotion = table19.TableDescriptor.GetFieldIndex("level_of_emotion");
			player_grudgelove_playerid = table19.TableDescriptor.GetFieldIndex("playerid");
			player_grudgelove_emotional_teamid = table19.TableDescriptor.GetFieldIndex("emotional_teamid");
		}
		Table table20 = fifaDb.GetTable("nations");
		if (table20 != null)
		{
			nations_nationname = table20.TableDescriptor.GetFieldIndex("nationname");
			nations_isocountrycode = table20.TableDescriptor.GetFieldIndex("isocountrycode");
			nations_nationid = table20.TableDescriptor.GetFieldIndex("nationid");
			nations_confederation = table20.TableDescriptor.GetFieldIndex("confederation");
			nations_top_tier = table20.TableDescriptor.GetFieldIndex("top_tier");
			nations_nationstartingfirstletter = table20.TableDescriptor.GetFieldIndex("nationstartingfirstletter");
		}
		Table table21 = fifaDb.GetTable("teamnationlinks");
		if (table21 != null)
		{
			teamnationlinks_nationid = table21.TableDescriptor.GetFieldIndex("nationid");
			teamnationlinks_teamid = table21.TableDescriptor.GetFieldIndex("teamid");
		}
		Table table22 = fifaDb.GetTable("manager");
		if (table22 != null)
		{
			manager_firstname = table22.TableDescriptor.GetFieldIndex("firstname");
			manager_surname = table22.TableDescriptor.GetFieldIndex("surname");
			manager_managerid = table22.TableDescriptor.GetFieldIndex("managerid");
			manager_headid = table22.TableDescriptor.GetFieldIndex("headid");
			manager_height = table22.TableDescriptor.GetFieldIndex("height");
			manager_hashighqualityhead = table22.TableDescriptor.GetFieldIndex("hashighqualityhead");
			manager_gender = table22.TableDescriptor.GetFieldIndex("gender");
			manager_suitvariationid = table22.TableDescriptor.GetFieldIndex("suitvariationid");
			manager_teamid = table22.TableDescriptor.GetFieldIndex("teamid");
			manager_suittypeid = table22.TableDescriptor.GetFieldIndex("suittypeid");
			manager_eyecolorcode = table22.TableDescriptor.GetFieldIndex("eyecolorcode");
			manager_headclasscode = table22.TableDescriptor.GetFieldIndex("headclasscode");
			manager_skintonecode = table22.TableDescriptor.GetFieldIndex("skintonecode");
			manager_bodytypecode = table22.TableDescriptor.GetFieldIndex("bodytypecode");
		}
		Table table23 = fifaDb.GetTable("leagueteamlinks");
		if (table23 != null)
		{
			leagueteamlinks_actualvsexpectations = table23.TableDescriptor.GetFieldIndex("actualvsexpectations");
			leagueteamlinks_artificialkey = table23.TableDescriptor.GetFieldIndex("artificialkey");
			leagueteamlinks_awaydraws = table23.TableDescriptor.GetFieldIndex("awaydraws");
			leagueteamlinks_awayga = table23.TableDescriptor.GetFieldIndex("awayga");
			leagueteamlinks_awaygf = table23.TableDescriptor.GetFieldIndex("awaygf");
			leagueteamlinks_awaylosses = table23.TableDescriptor.GetFieldIndex("awaylosses");
			leagueteamlinks_awaywins = table23.TableDescriptor.GetFieldIndex("awaywins");
			leagueteamlinks_champion = table23.TableDescriptor.GetFieldIndex("champion");
			leagueteamlinks_currenttableposition = table23.TableDescriptor.GetFieldIndex("currenttableposition");
			leagueteamlinks_grouping = table23.TableDescriptor.GetFieldIndex("grouping");
			leagueteamlinks_hasachievedobjective = table23.TableDescriptor.GetFieldIndex("hasachievedobjective");
			leagueteamlinks_highestpossible = table23.TableDescriptor.GetFieldIndex("highestpossible");
			leagueteamlinks_highestprobable = table23.TableDescriptor.GetFieldIndex("highestprobable");
			leagueteamlinks_homedraws = table23.TableDescriptor.GetFieldIndex("homedraws");
			leagueteamlinks_homega = table23.TableDescriptor.GetFieldIndex("homega");
			leagueteamlinks_homegf = table23.TableDescriptor.GetFieldIndex("homegf");
			leagueteamlinks_homelosses = table23.TableDescriptor.GetFieldIndex("homelosses");
			leagueteamlinks_homewins = table23.TableDescriptor.GetFieldIndex("homewins");
			leagueteamlinks_lastgameresult = table23.TableDescriptor.GetFieldIndex("lastgameresult");
			leagueteamlinks_leagueid = table23.TableDescriptor.GetFieldIndex("leagueid");
			leagueteamlinks_nummatchesplayed = table23.TableDescriptor.GetFieldIndex("nummatchesplayed");
			leagueteamlinks_objective = table23.TableDescriptor.GetFieldIndex("objective");
			leagueteamlinks_points = table23.TableDescriptor.GetFieldIndex("points");
			leagueteamlinks_previousyeartableposition = table23.TableDescriptor.GetFieldIndex("previousyeartableposition");
			leagueteamlinks_prevleagueid = table23.TableDescriptor.GetFieldIndex("prevleagueid");
			leagueteamlinks_teamform = table23.TableDescriptor.GetFieldIndex("teamform");
			leagueteamlinks_teamid = table23.TableDescriptor.GetFieldIndex("teamid");
			leagueteamlinks_teamlongform = table23.TableDescriptor.GetFieldIndex("teamlongform");
			leagueteamlinks_teamshortform = table23.TableDescriptor.GetFieldIndex("teamshortform");
			leagueteamlinks_unbeatenallcomps = table23.TableDescriptor.GetFieldIndex("unbeatenallcomps");
			leagueteamlinks_unbeatenaway = table23.TableDescriptor.GetFieldIndex("unbeatenaway");
			leagueteamlinks_unbeatenhome = table23.TableDescriptor.GetFieldIndex("unbeatenhome");
			leagueteamlinks_unbeatenleague = table23.TableDescriptor.GetFieldIndex("unbeatenleague");
			leagueteamlinks_yettowin = table23.TableDescriptor.GetFieldIndex("yettowin");
		}
		Table table24 = fifaDb.GetTable("leagues");
		if (table24 != null)
		{
			leagues_countryid = table24.TableDescriptor.GetFieldIndex("countryid");
			leagues_isbannerenabled = table24.TableDescriptor.GetFieldIndex("isbannerenabled");
			leagues_iscompetitioncrowdcardsenabled = table24.TableDescriptor.GetFieldIndex("iscompetitioncrowdcardsenabled");
			leagues_iscompetitionpoleflagenabled = table24.TableDescriptor.GetFieldIndex("iscompetitionpoleflagenabled");
			leagues_iscompetitionscarfenabled = table24.TableDescriptor.GetFieldIndex("iscompetitionscarfenabled");
			leagues_iswithintransferwindow = table24.TableDescriptor.GetFieldIndex("iswithintransferwindow");
			leagues_leagueid = table24.TableDescriptor.GetFieldIndex("leagueid");
			leagues_leaguename = table24.TableDescriptor.GetFieldIndex("leaguename");
			leagues_leaguetimeslice = table24.TableDescriptor.GetFieldIndex("leaguetimeslice");
			leagues_level = table24.TableDescriptor.GetFieldIndex("level");
		}
		Table table25 = fifaDb.GetTable("leaguerefereelinks");
		if (table25 != null)
		{
			leaguerefereelinks_leagueid = table25.TableDescriptor.GetFieldIndex("leagueid");
			leaguerefereelinks_refereeid = table25.TableDescriptor.GetFieldIndex("refereeid");
		}
		Table table26 = fifaDb.GetTable("formations");
		if (table26 != null)
		{
			formations_attackers = table26.TableDescriptor.GetFieldIndex("attackers");
			formations_defenders = table26.TableDescriptor.GetFieldIndex("defenders");
			formations_formationaudioid = table26.TableDescriptor.GetFieldIndex("formationaudioid");
			formations_formationfullnameid = table26.TableDescriptor.GetFieldIndex("formationfullnameid");
			formations_formationid = table26.TableDescriptor.GetFieldIndex("formationid");
			formations_formationname = table26.TableDescriptor.GetFieldIndex("formationname");
			formations_midfielders = table26.TableDescriptor.GetFieldIndex("midfielders");
			formations_offensiverating = table26.TableDescriptor.GetFieldIndex("offensiverating");
			formations_offset0x = table26.TableDescriptor.GetFieldIndex("offset0x");
			formations_offset0y = table26.TableDescriptor.GetFieldIndex("offset0y");
			formations_offset10x = table26.TableDescriptor.GetFieldIndex("offset10x");
			formations_offset10y = table26.TableDescriptor.GetFieldIndex("offset10y");
			formations_offset1x = table26.TableDescriptor.GetFieldIndex("offset1x");
			formations_offset1y = table26.TableDescriptor.GetFieldIndex("offset1y");
			formations_offset2x = table26.TableDescriptor.GetFieldIndex("offset2x");
			formations_offset2y = table26.TableDescriptor.GetFieldIndex("offset2y");
			formations_offset3x = table26.TableDescriptor.GetFieldIndex("offset3x");
			formations_offset3y = table26.TableDescriptor.GetFieldIndex("offset3y");
			formations_offset4x = table26.TableDescriptor.GetFieldIndex("offset4x");
			formations_offset4y = table26.TableDescriptor.GetFieldIndex("offset4y");
			formations_offset5x = table26.TableDescriptor.GetFieldIndex("offset5x");
			formations_offset5y = table26.TableDescriptor.GetFieldIndex("offset5y");
			formations_offset6x = table26.TableDescriptor.GetFieldIndex("offset6x");
			formations_offset6y = table26.TableDescriptor.GetFieldIndex("offset6y");
			formations_offset7x = table26.TableDescriptor.GetFieldIndex("offset7x");
			formations_offset7y = table26.TableDescriptor.GetFieldIndex("offset7y");
			formations_offset8x = table26.TableDescriptor.GetFieldIndex("offset8x");
			formations_offset8y = table26.TableDescriptor.GetFieldIndex("offset8y");
			formations_offset9x = table26.TableDescriptor.GetFieldIndex("offset9x");
			formations_offset9y = table26.TableDescriptor.GetFieldIndex("offset9y");
			formations_playerinstruction0_1 = table26.TableDescriptor.GetFieldIndex("playerinstruction0_1");
			formations_playerinstruction0_2 = table26.TableDescriptor.GetFieldIndex("playerinstruction0_2");
			formations_playerinstruction1_1 = table26.TableDescriptor.GetFieldIndex("playerinstruction1_1");
			formations_playerinstruction1_2 = table26.TableDescriptor.GetFieldIndex("playerinstruction1_2");
			formations_playerinstruction10_1 = table26.TableDescriptor.GetFieldIndex("playerinstruction10_1");
			formations_playerinstruction10_2 = table26.TableDescriptor.GetFieldIndex("playerinstruction10_2");
			formations_playerinstruction2_1 = table26.TableDescriptor.GetFieldIndex("playerinstruction2_1");
			formations_playerinstruction2_2 = table26.TableDescriptor.GetFieldIndex("playerinstruction2_2");
			formations_playerinstruction3_1 = table26.TableDescriptor.GetFieldIndex("playerinstruction3_1");
			formations_playerinstruction3_2 = table26.TableDescriptor.GetFieldIndex("playerinstruction3_2");
			formations_playerinstruction4_1 = table26.TableDescriptor.GetFieldIndex("playerinstruction4_1");
			formations_playerinstruction4_2 = table26.TableDescriptor.GetFieldIndex("playerinstruction4_2");
			formations_playerinstruction5_1 = table26.TableDescriptor.GetFieldIndex("playerinstruction5_1");
			formations_playerinstruction5_2 = table26.TableDescriptor.GetFieldIndex("playerinstruction5_2");
			formations_playerinstruction6_1 = table26.TableDescriptor.GetFieldIndex("playerinstruction6_1");
			formations_playerinstruction6_2 = table26.TableDescriptor.GetFieldIndex("playerinstruction6_2");
			formations_playerinstruction7_1 = table26.TableDescriptor.GetFieldIndex("playerinstruction7_1");
			formations_playerinstruction7_2 = table26.TableDescriptor.GetFieldIndex("playerinstruction7_2");
			formations_playerinstruction8_1 = table26.TableDescriptor.GetFieldIndex("playerinstruction8_1");
			formations_playerinstruction8_2 = table26.TableDescriptor.GetFieldIndex("playerinstruction8_2");
			formations_playerinstruction9_1 = table26.TableDescriptor.GetFieldIndex("playerinstruction9_1");
			formations_playerinstruction9_2 = table26.TableDescriptor.GetFieldIndex("playerinstruction9_2");
			formations_position0 = table26.TableDescriptor.GetFieldIndex("position0");
			formations_position1 = table26.TableDescriptor.GetFieldIndex("position1");
			formations_position10 = table26.TableDescriptor.GetFieldIndex("position10");
			formations_position2 = table26.TableDescriptor.GetFieldIndex("position2");
			formations_position3 = table26.TableDescriptor.GetFieldIndex("position3");
			formations_position4 = table26.TableDescriptor.GetFieldIndex("position4");
			formations_position5 = table26.TableDescriptor.GetFieldIndex("position5");
			formations_position6 = table26.TableDescriptor.GetFieldIndex("position6");
			formations_position7 = table26.TableDescriptor.GetFieldIndex("position7");
			formations_position8 = table26.TableDescriptor.GetFieldIndex("position8");
			formations_position9 = table26.TableDescriptor.GetFieldIndex("position9");
			formations_relativeformationid = table26.TableDescriptor.GetFieldIndex("relativeformationid");
			formations_teamid = table26.TableDescriptor.GetFieldIndex("teamid");
		}
		Table table27 = fifaDb.GetTable("defaultteamdata");
		if (table27 != null)
		{
			defaultteamdata_busbuildupspeed = table27.TableDescriptor.GetFieldIndex("busbuildupspeed");
			defaultteamdata_busdribbling = table27.TableDescriptor.GetFieldIndex("busdribbling");
			defaultteamdata_buspassing = table27.TableDescriptor.GetFieldIndex("buspassing");
			defaultteamdata_buspositioning = table27.TableDescriptor.GetFieldIndex("buspositioning");
			defaultteamdata_cccrossing = table27.TableDescriptor.GetFieldIndex("cccrossing");
			defaultteamdata_ccpassing = table27.TableDescriptor.GetFieldIndex("ccpassing");
			defaultteamdata_ccpositioning = table27.TableDescriptor.GetFieldIndex("ccpositioning");
			defaultteamdata_ccshooting = table27.TableDescriptor.GetFieldIndex("ccshooting");
			defaultteamdata_defaggression = table27.TableDescriptor.GetFieldIndex("defaggression");
			defaultteamdata_defdefenderline = table27.TableDescriptor.GetFieldIndex("defdefenderline");
			defaultteamdata_defmentality = table27.TableDescriptor.GetFieldIndex("defmentality");
			defaultteamdata_defteamwidth = table27.TableDescriptor.GetFieldIndex("defteamwidth");
			defaultteamdata_formationfullnameid = table27.TableDescriptor.GetFieldIndex("formationfullnameid");
			defaultteamdata_offset0x = table27.TableDescriptor.GetFieldIndex("offset0x");
			defaultteamdata_offset0y = table27.TableDescriptor.GetFieldIndex("offset0y");
			defaultteamdata_offset10x = table27.TableDescriptor.GetFieldIndex("offset10x");
			defaultteamdata_offset10y = table27.TableDescriptor.GetFieldIndex("offset10y");
			defaultteamdata_offset1x = table27.TableDescriptor.GetFieldIndex("offset1x");
			defaultteamdata_offset1y = table27.TableDescriptor.GetFieldIndex("offset1y");
			defaultteamdata_offset2x = table27.TableDescriptor.GetFieldIndex("offset2x");
			defaultteamdata_offset2y = table27.TableDescriptor.GetFieldIndex("offset2y");
			defaultteamdata_offset3x = table27.TableDescriptor.GetFieldIndex("offset3x");
			defaultteamdata_offset3y = table27.TableDescriptor.GetFieldIndex("offset3y");
			defaultteamdata_offset4x = table27.TableDescriptor.GetFieldIndex("offset4x");
			defaultteamdata_offset4y = table27.TableDescriptor.GetFieldIndex("offset4y");
			defaultteamdata_offset5x = table27.TableDescriptor.GetFieldIndex("offset5x");
			defaultteamdata_offset5y = table27.TableDescriptor.GetFieldIndex("offset5y");
			defaultteamdata_offset6x = table27.TableDescriptor.GetFieldIndex("offset6x");
			defaultteamdata_offset6y = table27.TableDescriptor.GetFieldIndex("offset6y");
			defaultteamdata_offset7x = table27.TableDescriptor.GetFieldIndex("offset7x");
			defaultteamdata_offset7y = table27.TableDescriptor.GetFieldIndex("offset7y");
			defaultteamdata_offset8x = table27.TableDescriptor.GetFieldIndex("offset8x");
			defaultteamdata_offset8y = table27.TableDescriptor.GetFieldIndex("offset8y");
			defaultteamdata_offset9x = table27.TableDescriptor.GetFieldIndex("offset9x");
			defaultteamdata_offset9y = table27.TableDescriptor.GetFieldIndex("offset9y");
			defaultteamdata_playerinstruction0_1 = table27.TableDescriptor.GetFieldIndex("playerinstruction0_1");
			defaultteamdata_playerinstruction0_2 = table27.TableDescriptor.GetFieldIndex("playerinstruction0_2");
			defaultteamdata_playerinstruction1_1 = table27.TableDescriptor.GetFieldIndex("playerinstruction1_1");
			defaultteamdata_playerinstruction1_2 = table27.TableDescriptor.GetFieldIndex("playerinstruction1_2");
			defaultteamdata_playerinstruction10_1 = table27.TableDescriptor.GetFieldIndex("playerinstruction10_1");
			defaultteamdata_playerinstruction10_2 = table27.TableDescriptor.GetFieldIndex("playerinstruction10_2");
			defaultteamdata_playerinstruction2_1 = table27.TableDescriptor.GetFieldIndex("playerinstruction2_1");
			defaultteamdata_playerinstruction2_2 = table27.TableDescriptor.GetFieldIndex("playerinstruction2_2");
			defaultteamdata_playerinstruction3_1 = table27.TableDescriptor.GetFieldIndex("playerinstruction3_1");
			defaultteamdata_playerinstruction3_2 = table27.TableDescriptor.GetFieldIndex("playerinstruction3_2");
			defaultteamdata_playerinstruction4_1 = table27.TableDescriptor.GetFieldIndex("playerinstruction4_1");
			defaultteamdata_playerinstruction4_2 = table27.TableDescriptor.GetFieldIndex("playerinstruction4_2");
			defaultteamdata_playerinstruction5_1 = table27.TableDescriptor.GetFieldIndex("playerinstruction5_1");
			defaultteamdata_playerinstruction5_2 = table27.TableDescriptor.GetFieldIndex("playerinstruction5_2");
			defaultteamdata_playerinstruction6_1 = table27.TableDescriptor.GetFieldIndex("playerinstruction6_1");
			defaultteamdata_playerinstruction6_2 = table27.TableDescriptor.GetFieldIndex("playerinstruction6_2");
			defaultteamdata_playerinstruction7_1 = table27.TableDescriptor.GetFieldIndex("playerinstruction7_1");
			defaultteamdata_playerinstruction7_2 = table27.TableDescriptor.GetFieldIndex("playerinstruction7_2");
			defaultteamdata_playerinstruction8_1 = table27.TableDescriptor.GetFieldIndex("playerinstruction8_1");
			defaultteamdata_playerinstruction8_2 = table27.TableDescriptor.GetFieldIndex("playerinstruction8_2");
			defaultteamdata_playerinstruction9_1 = table27.TableDescriptor.GetFieldIndex("playerinstruction9_1");
			defaultteamdata_playerinstruction9_2 = table27.TableDescriptor.GetFieldIndex("playerinstruction9_2");
			defaultteamdata_position0 = table27.TableDescriptor.GetFieldIndex("position0");
			defaultteamdata_position1 = table27.TableDescriptor.GetFieldIndex("position1");
			defaultteamdata_position10 = table27.TableDescriptor.GetFieldIndex("position10");
			defaultteamdata_position2 = table27.TableDescriptor.GetFieldIndex("position2");
			defaultteamdata_position3 = table27.TableDescriptor.GetFieldIndex("position3");
			defaultteamdata_position4 = table27.TableDescriptor.GetFieldIndex("position4");
			defaultteamdata_position5 = table27.TableDescriptor.GetFieldIndex("position5");
			defaultteamdata_position6 = table27.TableDescriptor.GetFieldIndex("position6");
			defaultteamdata_position7 = table27.TableDescriptor.GetFieldIndex("position7");
			defaultteamdata_position8 = table27.TableDescriptor.GetFieldIndex("position8");
			defaultteamdata_position9 = table27.TableDescriptor.GetFieldIndex("position9");
			defaultteamdata_tacticid = table27.TableDescriptor.GetFieldIndex("tacticid");
			defaultteamdata_teamid = table27.TableDescriptor.GetFieldIndex("teamid");
		}
		Table table28 = fifaDb.GetTable("default_teamsheets");
		if (table28 != null)
		{
			default_teamsheets_busbuildupspeed = table28.TableDescriptor.GetFieldIndex("busbuildupspeed");
			default_teamsheets_busdribbling = table28.TableDescriptor.GetFieldIndex("busdribbling");
			default_teamsheets_buspassing = table28.TableDescriptor.GetFieldIndex("buspassing");
			default_teamsheets_buspositioning = table28.TableDescriptor.GetFieldIndex("buspositioning");
			default_teamsheets_captainid = table28.TableDescriptor.GetFieldIndex("captainid");
			default_teamsheets_cccrossing = table28.TableDescriptor.GetFieldIndex("cccrossing");
			default_teamsheets_ccpassing = table28.TableDescriptor.GetFieldIndex("ccpassing");
			default_teamsheets_ccpositioning = table28.TableDescriptor.GetFieldIndex("ccpositioning");
			default_teamsheets_ccshooting = table28.TableDescriptor.GetFieldIndex("ccshooting");
			default_teamsheets_customsub0in = table28.TableDescriptor.GetFieldIndex("customsub0in");
			default_teamsheets_customsub0out = table28.TableDescriptor.GetFieldIndex("customsub0out");
			default_teamsheets_customsub1in = table28.TableDescriptor.GetFieldIndex("customsub1in");
			default_teamsheets_customsub1out = table28.TableDescriptor.GetFieldIndex("customsub1out");
			default_teamsheets_customsub2in = table28.TableDescriptor.GetFieldIndex("customsub2in");
			default_teamsheets_customsub2out = table28.TableDescriptor.GetFieldIndex("customsub2out");
			default_teamsheets_defaggression = table28.TableDescriptor.GetFieldIndex("defaggression");
			default_teamsheets_defdefenderline = table28.TableDescriptor.GetFieldIndex("defdefenderline");
			default_teamsheets_defmentality = table28.TableDescriptor.GetFieldIndex("defmentality");
			default_teamsheets_defteamwidth = table28.TableDescriptor.GetFieldIndex("defteamwidth");
			default_teamsheets_formationaudioid = table28.TableDescriptor.GetFieldIndex("formationaudioid");
			default_teamsheets_formationfullnameid = table28.TableDescriptor.GetFieldIndex("formationfullnameid");
			default_teamsheets_freekicktakerid = table28.TableDescriptor.GetFieldIndex("freekicktakerid");
			default_teamsheets_leftcornerkicktakerid = table28.TableDescriptor.GetFieldIndex("leftcornerkicktakerid");
			default_teamsheets_leftfreekicktakerid = table28.TableDescriptor.GetFieldIndex("leftfreekicktakerid");
			default_teamsheets_longkicktakerid = table28.TableDescriptor.GetFieldIndex("longkicktakerid");
			default_teamsheets_offset0x = table28.TableDescriptor.GetFieldIndex("offset0x");
			default_teamsheets_offset0y = table28.TableDescriptor.GetFieldIndex("offset0y");
			default_teamsheets_offset10x = table28.TableDescriptor.GetFieldIndex("offset10x");
			default_teamsheets_offset10y = table28.TableDescriptor.GetFieldIndex("offset10y");
			default_teamsheets_offset1x = table28.TableDescriptor.GetFieldIndex("offset1x");
			default_teamsheets_offset1y = table28.TableDescriptor.GetFieldIndex("offset1y");
			default_teamsheets_offset2x = table28.TableDescriptor.GetFieldIndex("offset2x");
			default_teamsheets_offset2y = table28.TableDescriptor.GetFieldIndex("offset2y");
			default_teamsheets_offset3x = table28.TableDescriptor.GetFieldIndex("offset3x");
			default_teamsheets_offset3y = table28.TableDescriptor.GetFieldIndex("offset3y");
			default_teamsheets_offset4x = table28.TableDescriptor.GetFieldIndex("offset4x");
			default_teamsheets_offset4y = table28.TableDescriptor.GetFieldIndex("offset4y");
			default_teamsheets_offset5x = table28.TableDescriptor.GetFieldIndex("offset5x");
			default_teamsheets_offset5y = table28.TableDescriptor.GetFieldIndex("offset5y");
			default_teamsheets_offset6x = table28.TableDescriptor.GetFieldIndex("offset6x");
			default_teamsheets_offset6y = table28.TableDescriptor.GetFieldIndex("offset6y");
			default_teamsheets_offset7x = table28.TableDescriptor.GetFieldIndex("offset7x");
			default_teamsheets_offset7y = table28.TableDescriptor.GetFieldIndex("offset7y");
			default_teamsheets_offset8x = table28.TableDescriptor.GetFieldIndex("offset8x");
			default_teamsheets_offset8y = table28.TableDescriptor.GetFieldIndex("offset8y");
			default_teamsheets_offset9x = table28.TableDescriptor.GetFieldIndex("offset9x");
			default_teamsheets_offset9y = table28.TableDescriptor.GetFieldIndex("offset9y");
			default_teamsheets_penaltytakerid = table28.TableDescriptor.GetFieldIndex("penaltytakerid");
			default_teamsheets_playerid0 = table28.TableDescriptor.GetFieldIndex("playerid0");
			default_teamsheets_playerid1 = table28.TableDescriptor.GetFieldIndex("playerid1");
			default_teamsheets_playerid10 = table28.TableDescriptor.GetFieldIndex("playerid10");
			default_teamsheets_playerid11 = table28.TableDescriptor.GetFieldIndex("playerid11");
			default_teamsheets_playerid12 = table28.TableDescriptor.GetFieldIndex("playerid12");
			default_teamsheets_playerid13 = table28.TableDescriptor.GetFieldIndex("playerid13");
			default_teamsheets_playerid14 = table28.TableDescriptor.GetFieldIndex("playerid14");
			default_teamsheets_playerid15 = table28.TableDescriptor.GetFieldIndex("playerid15");
			default_teamsheets_playerid16 = table28.TableDescriptor.GetFieldIndex("playerid16");
			default_teamsheets_playerid17 = table28.TableDescriptor.GetFieldIndex("playerid17");
			default_teamsheets_playerid18 = table28.TableDescriptor.GetFieldIndex("playerid18");
			default_teamsheets_playerid19 = table28.TableDescriptor.GetFieldIndex("playerid19");
			default_teamsheets_playerid2 = table28.TableDescriptor.GetFieldIndex("playerid2");
			default_teamsheets_playerid20 = table28.TableDescriptor.GetFieldIndex("playerid20");
			default_teamsheets_playerid21 = table28.TableDescriptor.GetFieldIndex("playerid21");
			default_teamsheets_playerid22 = table28.TableDescriptor.GetFieldIndex("playerid22");
			default_teamsheets_playerid23 = table28.TableDescriptor.GetFieldIndex("playerid23");
			default_teamsheets_playerid24 = table28.TableDescriptor.GetFieldIndex("playerid24");
			default_teamsheets_playerid25 = table28.TableDescriptor.GetFieldIndex("playerid25");
			default_teamsheets_playerid26 = table28.TableDescriptor.GetFieldIndex("playerid26");
			default_teamsheets_playerid27 = table28.TableDescriptor.GetFieldIndex("playerid27");
			default_teamsheets_playerid28 = table28.TableDescriptor.GetFieldIndex("playerid28");
			default_teamsheets_playerid29 = table28.TableDescriptor.GetFieldIndex("playerid29");
			default_teamsheets_playerid3 = table28.TableDescriptor.GetFieldIndex("playerid3");
			default_teamsheets_playerid30 = table28.TableDescriptor.GetFieldIndex("playerid30");
			default_teamsheets_playerid31 = table28.TableDescriptor.GetFieldIndex("playerid31");
			default_teamsheets_playerid32 = table28.TableDescriptor.GetFieldIndex("playerid32");
			default_teamsheets_playerid33 = table28.TableDescriptor.GetFieldIndex("playerid33");
			default_teamsheets_playerid34 = table28.TableDescriptor.GetFieldIndex("playerid34");
			default_teamsheets_playerid35 = table28.TableDescriptor.GetFieldIndex("playerid35");
			default_teamsheets_playerid36 = table28.TableDescriptor.GetFieldIndex("playerid36");
			default_teamsheets_playerid37 = table28.TableDescriptor.GetFieldIndex("playerid37");
			default_teamsheets_playerid38 = table28.TableDescriptor.GetFieldIndex("playerid38");
			default_teamsheets_playerid39 = table28.TableDescriptor.GetFieldIndex("playerid39");
			default_teamsheets_playerid4 = table28.TableDescriptor.GetFieldIndex("playerid4");
			default_teamsheets_playerid40 = table28.TableDescriptor.GetFieldIndex("playerid40");
			default_teamsheets_playerid41 = table28.TableDescriptor.GetFieldIndex("playerid41");
			default_teamsheets_playerid42 = table28.TableDescriptor.GetFieldIndex("playerid42");
			default_teamsheets_playerid43 = table28.TableDescriptor.GetFieldIndex("playerid43");
			default_teamsheets_playerid44 = table28.TableDescriptor.GetFieldIndex("playerid44");
			default_teamsheets_playerid45 = table28.TableDescriptor.GetFieldIndex("playerid45");
			default_teamsheets_playerid46 = table28.TableDescriptor.GetFieldIndex("playerid46");
			default_teamsheets_playerid47 = table28.TableDescriptor.GetFieldIndex("playerid47");
			default_teamsheets_playerid48 = table28.TableDescriptor.GetFieldIndex("playerid48");
			default_teamsheets_playerid49 = table28.TableDescriptor.GetFieldIndex("playerid49");
			default_teamsheets_playerid5 = table28.TableDescriptor.GetFieldIndex("playerid5");
			default_teamsheets_playerid50 = table28.TableDescriptor.GetFieldIndex("playerid50");
			default_teamsheets_playerid51 = table28.TableDescriptor.GetFieldIndex("playerid51");
			default_teamsheets_playerid6 = table28.TableDescriptor.GetFieldIndex("playerid6");
			default_teamsheets_playerid7 = table28.TableDescriptor.GetFieldIndex("playerid7");
			default_teamsheets_playerid8 = table28.TableDescriptor.GetFieldIndex("playerid8");
			default_teamsheets_playerid9 = table28.TableDescriptor.GetFieldIndex("playerid9");
			default_teamsheets_playerinstruction0_1 = table28.TableDescriptor.GetFieldIndex("playerinstruction0_1");
			default_teamsheets_playerinstruction0_2 = table28.TableDescriptor.GetFieldIndex("playerinstruction0_2");
			default_teamsheets_playerinstruction1_1 = table28.TableDescriptor.GetFieldIndex("playerinstruction1_1");
			default_teamsheets_playerinstruction1_2 = table28.TableDescriptor.GetFieldIndex("playerinstruction1_2");
			default_teamsheets_playerinstruction10_1 = table28.TableDescriptor.GetFieldIndex("playerinstruction10_1");
			default_teamsheets_playerinstruction10_2 = table28.TableDescriptor.GetFieldIndex("playerinstruction10_2");
			default_teamsheets_playerinstruction2_1 = table28.TableDescriptor.GetFieldIndex("playerinstruction2_1");
			default_teamsheets_playerinstruction2_2 = table28.TableDescriptor.GetFieldIndex("playerinstruction2_2");
			default_teamsheets_playerinstruction3_1 = table28.TableDescriptor.GetFieldIndex("playerinstruction3_1");
			default_teamsheets_playerinstruction3_2 = table28.TableDescriptor.GetFieldIndex("playerinstruction3_2");
			default_teamsheets_playerinstruction4_1 = table28.TableDescriptor.GetFieldIndex("playerinstruction4_1");
			default_teamsheets_playerinstruction4_2 = table28.TableDescriptor.GetFieldIndex("playerinstruction4_2");
			default_teamsheets_playerinstruction5_1 = table28.TableDescriptor.GetFieldIndex("playerinstruction5_1");
			default_teamsheets_playerinstruction5_2 = table28.TableDescriptor.GetFieldIndex("playerinstruction5_2");
			default_teamsheets_playerinstruction6_1 = table28.TableDescriptor.GetFieldIndex("playerinstruction6_1");
			default_teamsheets_playerinstruction6_2 = table28.TableDescriptor.GetFieldIndex("playerinstruction6_2");
			default_teamsheets_playerinstruction7_1 = table28.TableDescriptor.GetFieldIndex("playerinstruction7_1");
			default_teamsheets_playerinstruction7_2 = table28.TableDescriptor.GetFieldIndex("playerinstruction7_2");
			default_teamsheets_playerinstruction8_1 = table28.TableDescriptor.GetFieldIndex("playerinstruction8_1");
			default_teamsheets_playerinstruction8_2 = table28.TableDescriptor.GetFieldIndex("playerinstruction8_2");
			default_teamsheets_playerinstruction9_1 = table28.TableDescriptor.GetFieldIndex("playerinstruction9_1");
			default_teamsheets_playerinstruction9_2 = table28.TableDescriptor.GetFieldIndex("playerinstruction9_2");
			default_teamsheets_position0 = table28.TableDescriptor.GetFieldIndex("position0");
			default_teamsheets_position1 = table28.TableDescriptor.GetFieldIndex("position1");
			default_teamsheets_position10 = table28.TableDescriptor.GetFieldIndex("position10");
			default_teamsheets_position2 = table28.TableDescriptor.GetFieldIndex("position2");
			default_teamsheets_position3 = table28.TableDescriptor.GetFieldIndex("position3");
			default_teamsheets_position4 = table28.TableDescriptor.GetFieldIndex("position4");
			default_teamsheets_position5 = table28.TableDescriptor.GetFieldIndex("position5");
			default_teamsheets_position6 = table28.TableDescriptor.GetFieldIndex("position6");
			default_teamsheets_position7 = table28.TableDescriptor.GetFieldIndex("position7");
			default_teamsheets_position8 = table28.TableDescriptor.GetFieldIndex("position8");
			default_teamsheets_position9 = table28.TableDescriptor.GetFieldIndex("position9");
			default_teamsheets_rightcornerkicktakerid = table28.TableDescriptor.GetFieldIndex("rightcornerkicktakerid");
			default_teamsheets_rightfreekicktakerid = table28.TableDescriptor.GetFieldIndex("rightfreekicktakerid");
			default_teamsheets_sourceformationid = table28.TableDescriptor.GetFieldIndex("sourceformationid");
			default_teamsheets_tacticid = table28.TableDescriptor.GetFieldIndex("tacticid");
			default_teamsheets_teamid = table28.TableDescriptor.GetFieldIndex("teamid");
		}
		Table table29 = fifaDb.GetTable("fieldpositionboundingboxes");
		if (table29 != null)
		{
			fieldpositionboundingboxes_pointy1 = table29.TableDescriptor.GetFieldIndex("pointy1");
			fieldpositionboundingboxes_pointx1 = table29.TableDescriptor.GetFieldIndex("pointx1");
			fieldpositionboundingboxes_pointy0 = table29.TableDescriptor.GetFieldIndex("pointy0");
			fieldpositionboundingboxes_pointy3 = table29.TableDescriptor.GetFieldIndex("pointy3");
			fieldpositionboundingboxes_pointy2 = table29.TableDescriptor.GetFieldIndex("pointy2");
			fieldpositionboundingboxes_pointx0 = table29.TableDescriptor.GetFieldIndex("pointx0");
			fieldpositionboundingboxes_pointx3 = table29.TableDescriptor.GetFieldIndex("pointx3");
			fieldpositionboundingboxes_pointx2 = table29.TableDescriptor.GetFieldIndex("pointx2");
			fieldpositionboundingboxes_positionid = table29.TableDescriptor.GetFieldIndex("positionid");
		}
		Table table30 = fifaDb.GetTable("editedplayernames");
		if (table30 != null)
		{
			editedplayernames_firstname = table30.TableDescriptor.GetFieldIndex("firstname");
			editedplayernames_commonname = table30.TableDescriptor.GetFieldIndex("commonname");
			editedplayernames_playerjerseyname = table30.TableDescriptor.GetFieldIndex("playerjerseyname");
			editedplayernames_surname = table30.TableDescriptor.GetFieldIndex("surname");
			editedplayernames_playerid = table30.TableDescriptor.GetFieldIndex("playerid");
		}
		Table table31 = fifaDb.GetTable("competition");
		if (table31 != null)
		{
			competition_abbapenalties = table31.TableDescriptor.GetFieldIndex("abbapenalties");
			competition_adboardplacement = table31.TableDescriptor.GetFieldIndex("adboardplacement");
			competition_adboardplacementstage = table31.TableDescriptor.GetFieldIndex("adboardplacementstage");
			competition_authenticpodiumskin = table31.TableDescriptor.GetFieldIndex("authenticpodiumskin");
			competition_ballid = table31.TableDescriptor.GetFieldIndex("ballid");
			competition_colorregion = table31.TableDescriptor.GetFieldIndex("colorregion");
			competition_competitioncolor1b = table31.TableDescriptor.GetFieldIndex("competitioncolor1b");
			competition_competitioncolor1g = table31.TableDescriptor.GetFieldIndex("competitioncolor1g");
			competition_competitioncolor1r = table31.TableDescriptor.GetFieldIndex("competitioncolor1r");
			competition_competitioncolor2b = table31.TableDescriptor.GetFieldIndex("competitioncolor2b");
			competition_competitioncolor2g = table31.TableDescriptor.GetFieldIndex("competitioncolor2g");
			competition_competitioncolor2r = table31.TableDescriptor.GetFieldIndex("competitioncolor2r");
			competition_competitionid = table31.TableDescriptor.GetFieldIndex("competitionid");
			competition_competitionimportance = table31.TableDescriptor.GetFieldIndex("competitionimportance");
			competition_crowdskintonecode = table31.TableDescriptor.GetFieldIndex("crowdskintonecode");
			competition_goaljingle = table31.TableDescriptor.GetFieldIndex("goaljingle");
			competition_goalnetads = table31.TableDescriptor.GetFieldIndex("goalnetads");
			competition_inflatables = table31.TableDescriptor.GetFieldIndex("inflatables");
			competition_introconfetti = table31.TableDescriptor.GetFieldIndex("introconfetti");
			competition_isarchwayenabled = table31.TableDescriptor.GetFieldIndex("isarchwayenabled");
			competition_isarchwayenabledstage = table31.TableDescriptor.GetFieldIndex("isarchwayenabledstage");
			competition_isballplinthenabled = table31.TableDescriptor.GetFieldIndex("isballplinthenabled");
			competition_isballplinthenabledstage = table31.TableDescriptor.GetFieldIndex("isballplinthenabledstage");
			competition_isbannerenabled = table31.TableDescriptor.GetFieldIndex("isbannerenabled");
			competition_iscenterpitchflagenabled = table31.TableDescriptor.GetFieldIndex("iscenterpitchflagenabled");
			competition_iscenterpitchflagenabledstage = table31.TableDescriptor.GetFieldIndex("iscenterpitchflagenabledstage");
			competition_iscompetitioncrowdcardsenabled = table31.TableDescriptor.GetFieldIndex("iscompetitioncrowdcardsenabled");
			competition_iscompetitionpodiumenabled = table31.TableDescriptor.GetFieldIndex("iscompetitionpodiumenabled");
			competition_iscompetitionpoleflagenabled = table31.TableDescriptor.GetFieldIndex("iscompetitionpoleflagenabled");
			competition_iscompetitionscarfenabled = table31.TableDescriptor.GetFieldIndex("iscompetitionscarfenabled");
			competition_isflamethrowercannonsenabled = table31.TableDescriptor.GetFieldIndex("isflamethrowercannonsenabled");
			competition_isflamethrowercannonsenabledstage = table31.TableDescriptor.GetFieldIndex("isflamethrowercannonsenabledstage");
			competition_isgoallinetechcompenabled = table31.TableDescriptor.GetFieldIndex("isgoallinetechcompenabled");
			competition_isgoallinetechcompenabledstage = table31.TableDescriptor.GetFieldIndex("isgoallinetechcompenabledstage");
			competition_isgoallinetechhomeleagueenabled = table31.TableDescriptor.GetFieldIndex("isgoallinetechhomeleagueenabled");
			competition_isgoalnetadsenabledstage = table31.TableDescriptor.GetFieldIndex("isgoalnetadsenabledstage");
			competition_isinjuryboardenabled = table31.TableDescriptor.GetFieldIndex("isinjuryboardenabled");
			competition_isintroconfettienabledstage = table31.TableDescriptor.GetFieldIndex("isintroconfettienabledstage");
			competition_ispitchtarpsenabledstage = table31.TableDescriptor.GetFieldIndex("ispitchtarpsenabledstage");
			competition_isstadiumdressingenabled = table31.TableDescriptor.GetFieldIndex("isstadiumdressingenabled");
			competition_isstadiumdressingenabledstage = table31.TableDescriptor.GetFieldIndex("isstadiumdressingenabledstage");
			competition_isstadiumdressingunique = table31.TableDescriptor.GetFieldIndex("isstadiumdressingunique");
			competition_isstadiumdressinguniquestage = table31.TableDescriptor.GetFieldIndex("isstadiumdressinguniquestage");
			competition_isstanchionflamethrowerenabledstage = table31.TableDescriptor.GetFieldIndex("isstanchionflamethrowerenabledstage");
			competition_isteampitchflagenabled = table31.TableDescriptor.GetFieldIndex("isteampitchflagenabled");
			competition_isteampitchflagenabledstage = table31.TableDescriptor.GetFieldIndex("isteampitchflagenabledstage");
			competition_isuniqueadboardscompenabled = table31.TableDescriptor.GetFieldIndex("isuniqueadboardscompenabled");
			competition_isuniquehandshakeboardenabled = table31.TableDescriptor.GetFieldIndex("isuniquehandshakeboardenabled");
			competition_isuniqueleagueflagenabled = table31.TableDescriptor.GetFieldIndex("isuniqueleagueflagenabled");
			competition_isuniquetrophypedestalenabled = table31.TableDescriptor.GetFieldIndex("isuniquetrophypedestalenabled");
			competition_isvanishingsprayenabled = table31.TableDescriptor.GetFieldIndex("isvanishingsprayenabled");
			competition_isvanishingsprayhomeenabled = table31.TableDescriptor.GetFieldIndex("isvanishingsprayhomeenabled");
			competition_languageregion = table31.TableDescriptor.GetFieldIndex("languageregion");
			competition_onpitchgraphics = table31.TableDescriptor.GetFieldIndex("onpitchgraphics");
			competition_pitchtarps = table31.TableDescriptor.GetFieldIndex("pitchtarps");
			competition_replay360degree = table31.TableDescriptor.GetFieldIndex("replay360degree");
			competition_stadiumcrowdmap = table31.TableDescriptor.GetFieldIndex("stadiumcrowdmap");
			competition_stanchionflamethrower = table31.TableDescriptor.GetFieldIndex("stanchionflamethrower");
		}
		Table table32 = fifaDb.GetTable("career_lastnames");
		if (table32 != null)
		{
			career_lastnames_lastname = table32.TableDescriptor.GetFieldIndex("lastname");
			career_lastnames_lastnameid = table32.TableDescriptor.GetFieldIndex("lastnameid");
			career_lastnames_groupid = table32.TableDescriptor.GetFieldIndex("groupid");
		}
		Table table33 = fifaDb.GetTable("career_firstnames");
		if (table33 != null)
		{
			career_firstnames_firstname = table33.TableDescriptor.GetFieldIndex("firstname");
			career_firstnames_firstnameid = table33.TableDescriptor.GetFieldIndex("firstnameid");
			career_firstnames_groupid = table33.TableDescriptor.GetFieldIndex("groupid");
		}
		Table table34 = fifaDb.GetTable("career_commonnames");
		if (table34 != null)
		{
			career_commonnames_firstname = table34.TableDescriptor.GetFieldIndex("firstname");
			career_commonnames_lastname = table34.TableDescriptor.GetFieldIndex("lastname");
			career_commonnames_commonnameid = table34.TableDescriptor.GetFieldIndex("commonnameid");
			career_commonnames_groupid = table34.TableDescriptor.GetFieldIndex("groupid");
		}
		Table table35 = fifaDb.GetTable("attributeprefpositionformula");
		if (table35 != null)
		{
			attributeprefpositionformula_attribute = table35.TableDescriptor.GetFieldIndex("attribute");
			attributeprefpositionformula_position = table35.TableDescriptor.GetFieldIndex("position");
			attributeprefpositionformula_percentage = table35.TableDescriptor.GetFieldIndex("percentage");
		}
		Table table36 = fifaDb.GetTable("audionation");
		if (table36 != null)
		{
			audionation_nationid = table36.TableDescriptor.GetFieldIndex("nationid");
			audionation_PALanguageIndex = table36.TableDescriptor.GetFieldIndex("palanguageindex");
			audionation_DefaultCommLang = table36.TableDescriptor.GetFieldIndex("defaultcommlang");
			audionation_CrowdBedsRegionIndex = table36.TableDescriptor.GetFieldIndex("crowdbedsregionindex");
			audionation_WhistlesRegionIndex = table36.TableDescriptor.GetFieldIndex("whistlesregionindex");
			audionation_AmbienceRegionIndex = table36.TableDescriptor.GetFieldIndex("ambienceregionindex");
			audionation_PlayerCallPatchBankIndex = table36.TableDescriptor.GetFieldIndex("playercallpatchbankindex");
			audionation_HecklesRegionIndex = table36.TableDescriptor.GetFieldIndex("hecklesregionindex");
			audionation_ChantRegionIndex = table36.TableDescriptor.GetFieldIndex("chantregionindex");
			audionation_TeamCanWhistleIndex = table36.TableDescriptor.GetFieldIndex("teamcanwhistleindex");
			audionation_ReactionsRegionIndex = table36.TableDescriptor.GetFieldIndex("reactionsregionindex");
		}
		Table table37 = fifaDb.GetTable("audiostadium");
		if (table37 != null)
		{
			audiostadium_stadiumid = table37.TableDescriptor.GetFieldIndex("stadiumid");
			audiostadium_stadiumpalanguageindex = table37.TableDescriptor.GetFieldIndex("stadiumpalanguageindex");
		}
		Table table38 = fifaDb.GetTable("career_boardoutcomes");
		if (table38 != null)
		{
			career_boardoutcomes_leagueid = table38.TableDescriptor.GetFieldIndex("leagueid");
			career_boardoutcomes_outcome1 = table38.TableDescriptor.GetFieldIndex("outcome1");
			career_boardoutcomes_outcome2 = table38.TableDescriptor.GetFieldIndex("outcome2");
			career_boardoutcomes_outcome3 = table38.TableDescriptor.GetFieldIndex("outcome3");
			career_boardoutcomes_outcome4 = table38.TableDescriptor.GetFieldIndex("outcome4");
			career_boardoutcomes_outcome5 = table38.TableDescriptor.GetFieldIndex("outcome5");
		}
		Table table39 = fifaDb.GetTable("clubcommentarynames");
		if (table39 != null)
		{
			clubcommentarynames_commentaryid = table39.TableDescriptor.GetFieldIndex("commentaryid");
			clubcommentarynames_commentarystartingletter = table39.TableDescriptor.GetFieldIndex("commentarystartingletter");
		}
		Table table40 = fifaDb.GetTable("commentarynames");
		if (table40 != null)
		{
			commentarynames_commentarystring = table40.TableDescriptor.GetFieldIndex("commentarystring");
			commentarynames_commentaryid = table40.TableDescriptor.GetFieldIndex("commentaryid");
			commentarynames_commentarystartingletter = table40.TableDescriptor.GetFieldIndex("commentarystartingletter");
			commentarynames_commentarypreview = table40.TableDescriptor.GetFieldIndex("commentarypreview");
		}
		Table table41 = fifaDb.GetTable("cz_assets");
		if (table41 != null)
		{
			cz_assets_crestid = table41.TableDescriptor.GetFieldIndex("crestid");
			cz_assets_dbid = table41.TableDescriptor.GetFieldIndex("dbid");
			cz_assets_publishdate = table41.TableDescriptor.GetFieldIndex("publishdate");
			cz_assets_rating = table41.TableDescriptor.GetFieldIndex("rating");
			cz_assets_kitid = table41.TableDescriptor.GetFieldIndex("kitid");
			cz_assets_xms_media_id = table41.TableDescriptor.GetFieldIndex("xms_media_id");
			cz_assets_type = table41.TableDescriptor.GetFieldIndex("type");
			cz_assets_author = table41.TableDescriptor.GetFieldIndex("author");
			cz_assets_assetname = table41.TableDescriptor.GetFieldIndex("assetname");
			cz_assets_assetyear = table41.TableDescriptor.GetFieldIndex("assetyear");
			cz_assets_playerposition = table41.TableDescriptor.GetFieldIndex("playerposition");
			cz_assets_version = table41.TableDescriptor.GetFieldIndex("version");
		}
		Table table42 = fifaDb.GetTable("cz_teams");
		if (table42 != null)
		{
			cz_teams_hascrestimage = table42.TableDescriptor.GetFieldIndex("hascrestimage");
			cz_teams_hassponsorimage = table42.TableDescriptor.GetFieldIndex("hassponsorimage");
			cz_teams_teamabbrev3 = table42.TableDescriptor.GetFieldIndex("teamabbrev3");
			cz_teams_teamid = table42.TableDescriptor.GetFieldIndex("teamid");
			cz_teams_commentaryid = table42.TableDescriptor.GetFieldIndex("commentaryid");
		}
		Table table43 = fifaDb.GetTable("cz_teamkits");
		if (table43 != null)
		{
			cz_teamkits_hotspotjerseyfrontsponsorr = table43.TableDescriptor.GetFieldIndex("hotspotjerseyfrontsponsorr");
			cz_teamkits_hotspotjerseyfrontsponsorb = table43.TableDescriptor.GetFieldIndex("hotspotjerseyfrontsponsorb");
			cz_teamkits_hotspotjerseyfrontsponsorl = table43.TableDescriptor.GetFieldIndex("hotspotjerseyfrontsponsorl");
			cz_teamkits_assetid = table43.TableDescriptor.GetFieldIndex("assetid");
			cz_teamkits_hotspotjerseyfrontsponsort = table43.TableDescriptor.GetFieldIndex("hotspotjerseyfrontsponsort");
			cz_teamkits_sockscolortertr = table43.TableDescriptor.GetFieldIndex("sockscolortertr");
			cz_teamkits_jerseycolorprimg = table43.TableDescriptor.GetFieldIndex("jerseycolorprimg");
			cz_teamkits_jerseycolortertg = table43.TableDescriptor.GetFieldIndex("jerseycolortertg");
			cz_teamkits_sponsorcolourg = table43.TableDescriptor.GetFieldIndex("sponsorcolourg");
			cz_teamkits_sockscolorsecb = table43.TableDescriptor.GetFieldIndex("sockscolorsecb");
			cz_teamkits_sponsorcolourr = table43.TableDescriptor.GetFieldIndex("sponsorcolourr");
			cz_teamkits_sockscolortertg = table43.TableDescriptor.GetFieldIndex("sockscolortertg");
			cz_teamkits_shortcolorsecb = table43.TableDescriptor.GetFieldIndex("shortcolorsecb");
			cz_teamkits_shortcolortertg = table43.TableDescriptor.GetFieldIndex("shortcolortertg");
			cz_teamkits_numberfonttype = table43.TableDescriptor.GetFieldIndex("numberfonttype");
			cz_teamkits_shortcolorprimb = table43.TableDescriptor.GetFieldIndex("shortcolorprimb");
			cz_teamkits_jerseycolorsecr = table43.TableDescriptor.GetFieldIndex("jerseycolorsecr");
			cz_teamkits_jerseynamefonttype = table43.TableDescriptor.GetFieldIndex("jerseynamefonttype");
			cz_teamkits_jerseynamelayouttype = table43.TableDescriptor.GetFieldIndex("jerseynamelayouttype");
			cz_teamkits_jerseycolortertb = table43.TableDescriptor.GetFieldIndex("jerseycolortertb");
			cz_teamkits_shortsnumbercolor = table43.TableDescriptor.GetFieldIndex("shortsnumbercolor");
			cz_teamkits_jerseyshapestyle = table43.TableDescriptor.GetFieldIndex("jerseyshapestyle");
			cz_teamkits_shortcolortertr = table43.TableDescriptor.GetFieldIndex("shortcolortertr");
			cz_teamkits_shortcolorsecr = table43.TableDescriptor.GetFieldIndex("shortcolorsecr");
			cz_teamkits_jerseynamecolorg = table43.TableDescriptor.GetFieldIndex("jerseynamecolorg");
			cz_teamkits_jerseycolorprimr = table43.TableDescriptor.GetFieldIndex("jerseycolorprimr");
			cz_teamkits_sponsorcolourb = table43.TableDescriptor.GetFieldIndex("sponsorcolourb");
			cz_teamkits_sockscolorsecg = table43.TableDescriptor.GetFieldIndex("sockscolorsecg");
			cz_teamkits_jerseycolorsecb = table43.TableDescriptor.GetFieldIndex("jerseycolorsecb");
			cz_teamkits_sockscolorprimg = table43.TableDescriptor.GetFieldIndex("sockscolorprimg");
			cz_teamkits_shortcolorprimr = table43.TableDescriptor.GetFieldIndex("shortcolorprimr");
			cz_teamkits_jerseycolortertr = table43.TableDescriptor.GetFieldIndex("jerseycolortertr");
			cz_teamkits_shortcolorsecg = table43.TableDescriptor.GetFieldIndex("shortcolorsecg");
			cz_teamkits_jerseycolorprimb = table43.TableDescriptor.GetFieldIndex("jerseycolorprimb");
			cz_teamkits_sockscolorprimr = table43.TableDescriptor.GetFieldIndex("sockscolorprimr");
			cz_teamkits_sockscolorsecr = table43.TableDescriptor.GetFieldIndex("sockscolorsecr");
			cz_teamkits_shortcolortertb = table43.TableDescriptor.GetFieldIndex("shortcolortertb");
			cz_teamkits_jerseynamecolorr = table43.TableDescriptor.GetFieldIndex("jerseynamecolorr");
			cz_teamkits_numbercolor = table43.TableDescriptor.GetFieldIndex("numbercolor");
			cz_teamkits_sockscolorprimb = table43.TableDescriptor.GetFieldIndex("sockscolorprimb");
			cz_teamkits_jerseycolorsecg = table43.TableDescriptor.GetFieldIndex("jerseycolorsecg");
			cz_teamkits_shortsnumberfonttype = table43.TableDescriptor.GetFieldIndex("shortsnumberfonttype");
			cz_teamkits_jerseynamecolorb = table43.TableDescriptor.GetFieldIndex("jerseynamecolorb");
			cz_teamkits_shortcolorprimg = table43.TableDescriptor.GetFieldIndex("shortcolorprimg");
			cz_teamkits_sockscolortertb = table43.TableDescriptor.GetFieldIndex("sockscolortertb");
			cz_teamkits_jerseybacknamefontcase = table43.TableDescriptor.GetFieldIndex("jerseybacknamefontcase");
			cz_teamkits_hassponsor = table43.TableDescriptor.GetFieldIndex("hassponsor");
			cz_teamkits_jerseybacknameplacementcode = table43.TableDescriptor.GetFieldIndex("jerseybacknameplacementcode");
			cz_teamkits_artificialkey = table43.TableDescriptor.GetFieldIndex("artificialkey");
			cz_teamkits_teamid = table43.TableDescriptor.GetFieldIndex("teamid");
			cz_teamkits_kitid = table43.TableDescriptor.GetFieldIndex("kitid");
			cz_teamkits_kittypeid = table43.TableDescriptor.GetFieldIndex("kittypeid");
		}
		Table table44 = fifaDb.GetTable("cz_players");
		if (table44 != null)
		{
			cz_players_assetid = table44.TableDescriptor.GetFieldIndex("assetid");
			cz_players_commentaryid = table44.TableDescriptor.GetFieldIndex("commentaryid");
			cz_players_playerid = table44.TableDescriptor.GetFieldIndex("playerid");
		}
		Table table45 = fifaDb.GetTable("cz_leagues");
		if (table45 != null)
		{
			cz_leagues_overlaybgcolour3r = table45.TableDescriptor.GetFieldIndex("overlaybgcolour3r");
			cz_leagues_tournamentballid = table45.TableDescriptor.GetFieldIndex("tournamentballid");
			cz_leagues_overlaytextcolour3r = table45.TableDescriptor.GetFieldIndex("overlaytextcolour3r");
			cz_leagues_overlaytextcolour1g = table45.TableDescriptor.GetFieldIndex("overlaytextcolour1g");
			cz_leagues_overlaytextcolour3b = table45.TableDescriptor.GetFieldIndex("overlaytextcolour3b");
			cz_leagues_overlaybgcolour1g = table45.TableDescriptor.GetFieldIndex("overlaybgcolour1g");
			cz_leagues_championcupslotallotment = table45.TableDescriptor.GetFieldIndex("championcupslotallotment");
			cz_leagues_overlaybgcolour3b = table45.TableDescriptor.GetFieldIndex("overlaybgcolour3b");
			cz_leagues_finalstadiumid = table45.TableDescriptor.GetFieldIndex("finalstadiumid");
			cz_leagues_overlaytextcolour2b = table45.TableDescriptor.GetFieldIndex("overlaytextcolour2b");
			cz_leagues_overlaybgcolour1r = table45.TableDescriptor.GetFieldIndex("overlaybgcolour1r");
			cz_leagues_overlaybgcolour2b = table45.TableDescriptor.GetFieldIndex("overlaybgcolour2b");
			cz_leagues_overlaytextcolour1r = table45.TableDescriptor.GetFieldIndex("overlaytextcolour1r");
			cz_leagues_overlaytextcolour3g = table45.TableDescriptor.GetFieldIndex("overlaytextcolour3g");
			cz_leagues_overlaytextcolour1b = table45.TableDescriptor.GetFieldIndex("overlaytextcolour1b");
			cz_leagues_overlaybgcolour3g = table45.TableDescriptor.GetFieldIndex("overlaybgcolour3g");
			cz_leagues_overlaybgcolour1b = table45.TableDescriptor.GetFieldIndex("overlaybgcolour1b");
			cz_leagues_overlaybgcolour2r = table45.TableDescriptor.GetFieldIndex("overlaybgcolour2r");
			cz_leagues_overlaytextcolour2g = table45.TableDescriptor.GetFieldIndex("overlaytextcolour2g");
			cz_leagues_eurocupslotallotment = table45.TableDescriptor.GetFieldIndex("eurocupslotallotment");
			cz_leagues_overlaytextcolour2r = table45.TableDescriptor.GetFieldIndex("overlaytextcolour2r");
			cz_leagues_overlaybgcolour2g = table45.TableDescriptor.GetFieldIndex("overlaybgcolour2g");
			cz_leagues_leaguedescription = table45.TableDescriptor.GetFieldIndex("leaguedescription");
			cz_leagues_leaguetype = table45.TableDescriptor.GetFieldIndex("leaguetype");
			cz_leagues_numteams = table45.TableDescriptor.GetFieldIndex("numteams");
			cz_leagues_trophyid = table45.TableDescriptor.GetFieldIndex("trophyid");
			cz_leagues_teamadvancingpergroup = table45.TableDescriptor.GetFieldIndex("teamadvancingpergroup");
			cz_leagues_leagueid = table45.TableDescriptor.GetFieldIndex("leagueid");
			cz_leagues_fixturevsgroup = table45.TableDescriptor.GetFieldIndex("fixturevsgroup");
			cz_leagues_teampergroup = table45.TableDescriptor.GetFieldIndex("teampergroup");
			cz_leagues_finalmatchlegs = table45.TableDescriptor.GetFieldIndex("finalmatchlegs");
			cz_leagues_fixturevseachteam = table45.TableDescriptor.GetFieldIndex("fixturevseachteam");
			cz_leagues_subonbench = table45.TableDescriptor.GetFieldIndex("subonbench");
		}
		Table table46 = fifaDb.GetTable("career_newspicweights");
		if (table46 != null)
		{
			career_newspicweights_maxvariationspos = table46.TableDescriptor.GetFieldIndex("maxvariationspos");
			career_newspicweights_maxvariationsstd = table46.TableDescriptor.GetFieldIndex("maxvariationsstd");
			career_newspicweights_maxvariationsneg = table46.TableDescriptor.GetFieldIndex("maxvariationsneg");
			career_newspicweights_crestweight = table46.TableDescriptor.GetFieldIndex("crestweight");
			career_newspicweights_teamweight = table46.TableDescriptor.GetFieldIndex("teamweight");
			career_newspicweights_teamid = table46.TableDescriptor.GetFieldIndex("teamid");
			career_newspicweights_genericweight = table46.TableDescriptor.GetFieldIndex("genericweight");
		}
		Table table47 = fifaDb.GetTable("stadiumassignments");
		if (table47 != null)
		{
			stadiumassignments_stadiumcustomname = table47.TableDescriptor.GetFieldIndex("stadiumcustomname");
			stadiumassignments_teamid = table47.TableDescriptor.GetFieldIndex("teamid");
		}
		Table table48 = fifaDb.GetTable("playerloans");
		if (table48 != null)
		{
			playerloans_playerid = table48.TableDescriptor.GetFieldIndex("playerid");
			playerloans_teamidloanedfrom = table48.TableDescriptor.GetFieldIndex("teamidloanedfrom");
			playerloans_loandateend = table48.TableDescriptor.GetFieldIndex("loandateend");
		}
		Table table49 = fifaDb.GetTable("career_presignedcontract");
		if (table49 != null)
		{
			career_presignedcontract_signdate = table49.TableDescriptor.GetFieldIndex("signeddate");
			career_presignedcontract_iscomingthisseason = table49.TableDescriptor.GetFieldIndex("iscomingthisseason");
			career_presignedcontract_offerteamid = table49.TableDescriptor.GetFieldIndex("offerteamid");
			career_presignedcontract_offerid = table49.TableDescriptor.GetFieldIndex("offerid");
			career_presignedcontract_future_fee = table49.TableDescriptor.GetFieldIndex("future_fee");
			career_presignedcontract_performancebonuscount = table49.TableDescriptor.GetFieldIndex("performancebonuscount");
			career_presignedcontract_exchangeplayerwage = table49.TableDescriptor.GetFieldIndex("exchangeplayerwage");
			career_presignedcontract_currentcontractwage = table49.TableDescriptor.GetFieldIndex("currentcontractwage");
			career_presignedcontract_exchangeplayerid = table49.TableDescriptor.GetFieldIndex("exchangeplayerid");
			career_presignedcontract_offeredfee = table49.TableDescriptor.GetFieldIndex("offeredfee");
			career_presignedcontract_offeredwage = table49.TableDescriptor.GetFieldIndex("offeredwage");
			career_presignedcontract_performancebonusvalue = table49.TableDescriptor.GetFieldIndex("performancebonusvalue");
			career_presignedcontract_performancebonustype = table49.TableDescriptor.GetFieldIndex("performancebonustype");
			career_presignedcontract_completedate = table49.TableDescriptor.GetFieldIndex("completedate");
			career_presignedcontract_isloanbuy = table49.TableDescriptor.GetFieldIndex("isloanbuy");
			career_presignedcontract_signonbonus = table49.TableDescriptor.GetFieldIndex("signonbonus");
			career_presignedcontract_teamid = table49.TableDescriptor.GetFieldIndex("teamid");
			career_presignedcontract_offeredcontracttype = table49.TableDescriptor.GetFieldIndex("offeredcontracttype");
			career_presignedcontract_releaseclause = table49.TableDescriptor.GetFieldIndex("releaseclause");
			career_presignedcontract_playerid = table49.TableDescriptor.GetFieldIndex("playerid");
			career_presignedcontract_squadrole = table49.TableDescriptor.GetFieldIndex("squadrole");
		}
		Table table50 = fifaDb.GetTable("career_users");
		if (table50 != null)
		{
			career_users_agentname = table50.TableDescriptor.GetFieldIndex("agentname");
			career_users_clubteamid = table50.TableDescriptor.GetFieldIndex("clubteamid");
			career_users_firstname = table50.TableDescriptor.GetFieldIndex("firstname");
			career_users_goalnews = table50.TableDescriptor.GetFieldIndex("goalnews");
			career_users_leagueid = table50.TableDescriptor.GetFieldIndex("leagueid");
			career_users_leagueseasonmessagesent = table50.TableDescriptor.GetFieldIndex("leagueseasonmessagesent");
			career_users_nationalityid = table50.TableDescriptor.GetFieldIndex("nationalityid");
			career_users_nationalteamid = table50.TableDescriptor.GetFieldIndex("nationalteamid");
			career_users_playertype = table50.TableDescriptor.GetFieldIndex("playertype");
			career_users_primarycompobjid = table50.TableDescriptor.GetFieldIndex("primarycompobjid");
			career_users_seasoncount = table50.TableDescriptor.GetFieldIndex("seasoncount");
			career_users_sponsorid = table50.TableDescriptor.GetFieldIndex("sponsorid");
			career_users_surname = table50.TableDescriptor.GetFieldIndex("surname");
			career_users_userid = table50.TableDescriptor.GetFieldIndex("userid");
			career_users_usertype = table50.TableDescriptor.GetFieldIndex("usertype");
			career_users_wage = table50.TableDescriptor.GetFieldIndex("wage");
		}
	}
}
