...
public class TableDescriptor
{
	...
	public int NStringFields
	{
		get
		{
			return m_NStringFields;
		}
		set
		{
			m_NStringFields = value;
		}
	}
	...
	public int NCompressedStringFields
	{
		get
		{
			return m_NCompressedStringFields;
		}
		set
		{
			m_NCompressedStringFields = value;
		}
	}
	...
	private void AssignXmlTableName()
	{
		...
		for (int i = 0; i < count; i++)
		{
			...
			{
				string tableName = (string)dataRow["name"];
