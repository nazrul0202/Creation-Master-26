...
public class Shoes : IdObject
{
		...
		: base(r.IntField[FI.playerboots_shoetype])
	{
		...
		m_IsAdidas = r.IntField[FI.playerboots_isadidas] > 0;
		m_IsAvailableinStore = r.IntField[FI.playerboots_isavailableinstore] > 0;
		m_IsEmbargoed = r.IntField[FI.playerboots_isembargoed] > 0;
		if (FI.playerboots_gender >= 0)
		{
			m_IsGender = ((r.IntField[FI.playerboots_gender] != 0) ? true : false);
		}
		m_IsLegacy = r.IntField[FI.playerboots_islegacy] > 0;
		m_IsLicensed = r.IntField[FI.playerboots_islicensed] > 0;
		m_IsLocked = r.IntField[FI.playerboots_islocked] > 0;
	...
	{
		return "data/sceneassets/shoe/shoe_" + shoesBrand + "_" + shoesDesign + "_textures.rx3";
	}

	public static string ShoesModelFileName(int shoesBrand)
	{
		return "data/sceneassets/shoe/shoe_" + shoesBrand + ".rx3";
	}
	...
	public static bool SetShoesTextures(int shoesBrand, int shoesDesign, Bitmap[] bitmaps)
	{
		...
		return FifaEnvironment.ImportBmpsIntoZdata(ids: new int[2] { shoesBrand, shoesDesign }, templateRx3Name: ShoeTemplateFilename(), bitmaps: bitmaps, compressionMode: ECompressionMode.Chunkzip);
	}
