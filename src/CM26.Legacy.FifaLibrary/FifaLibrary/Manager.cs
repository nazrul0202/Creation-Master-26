...
public class Manager : IdObject
{
	public static string RevModManagerTextureFileName(int teamId)
	{
		...
		{
			return "data/sceneassets/manager/specificmanager_" + teamId + "_0_0_textures.rx3";
		}
		return "data/sceneassets/slc/specificmanager_" + teamId + "_0_0_textures.rx3";
	}
	...
	public static string ManagerTextureFileName(int dress, int skin, int color, int coat)
	{
		if (FifaEnvironment.Year == 14)
		{
			return "data/sceneassets/manager/manager_" + dress + "_" + skin + "_" + color + "_" + coat + "_textures.rx3";
		}
		return "data/sceneassets/slc/manager_" + dress + "_0_" + skin + "_" + color + "_" + coat + "_textures.rx3";
	}
	...
	public static string ManagerModelFileName(int dress, int body, int coat)
	{
		if (FifaEnvironment.Year == 14)
		{
			return "data/sceneassets/manager/manager_" + dress + "_" + body + "_" + coat + ".rx3";
		}
		return "data/sceneassets/slc/manager_" + dress + "_" + body + "_1_" + coat + ".rx3";
	}
	...
	public static string RevModManagerModelFileName(int teamId)
	{
		if (FifaEnvironment.Year == 14)
		{
			return "data/sceneassets/manager/specificmanager_" + teamId + "_0_0.rx3";
		}
		return "data/sceneassets/slc/specificmanager_" + teamId + "_0_0.rx3";
	}
	...
	{
		return FifaEnvironment.ImportBmpsIntoZdata(bitmaps: new Bitmap[1] { bitmap }, templateRx3Name: "data/sceneassets/manager/specificmanager_#_0_0_textures.rx3", rx3FileName: RevModManagerTextureFileName(teamId), compressionMode: ECompressionMode.None, signatures: null);
	}
	...
	{
		return FifaEnvironment.ImportBmpsIntoZdata(bitmaps: new Bitmap[1] { bitmap }, templateRx3Name: ManagerTextureFileName(0, 0, 0, 0), rx3FileName: ManagerTextureFileName(dress, skin, color, coat), compressionMode: ECompressionMode.Chunkzip, signatures: ManagerSignature(dress, skin, color, coat));
	}
	...
	private static Rx3Signatures ManagerSignature(int dress, int skin, int color, int coat)
	{
		if (FifaEnvironment.Year == 14)
		{
			return new Rx3Signatures(1398432, 36, new string[1] { "manager_" + dress + "_" + skin + "_" + color + "_" + coat + "_cm.Raster" });
		}
		return new Rx3Signatures(2097968, 27, new string[1] { "manager_" + dress + "_" + skin + "_" + color + "_" + coat + "_cm" });
	}
}
