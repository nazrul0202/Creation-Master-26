...
public class Police : IdObject
{
	...
	public static string PoliceFileName(int policeid, int type)
	{
		...
		{
			return "data/sceneassets/policeofficer/policeofficer_" + policeid + "_0_0_" + type + "_textures.rx3";
		}
		return "data/sceneassets/slc/policeofficer_" + policeid + "_0_0_" + type + "_textures.rx3";
	}
	...
	{
		return FifaEnvironment.ImportBmpsIntoZdata(ids: new int[2] { policeid, type }, templateRx3Name: PoliceTemplateName(), bitmap: bitmap, compressionMode: ECompressionMode.Chunkzip, signatures: PoliceSignature(policeid, type));
	}
	...
	{
		return new Rx3Signatures(43984, 48, new string[1] { "policeofficer_" + policeid + "_0_0_" + type + "_cm.Raster" });
	}
}
