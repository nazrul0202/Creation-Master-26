...
public class Ball : IdObject
{
	...
	{
		return "data/sceneassets/ball/ball_" + ballId + "_textures.rx3";
	}

	public static string RevModTeamBallTextureFileName(int teamId)
	{
		return "data/sceneassets/ball/specificball_" + teamId + "_0_0_textures.rx3";
	}

	public static string RevModTrophyBallTextureFileName(int assetId)
	{
		return "data/sceneassets/ball/specificball_0_" + assetId + "_0_textures.rx3";
	}
	...
	{
		return "data/ui/artassets/settingsimg/ball_" + ballId + ".big";
	}
	...
	{
		return "data/ui/imgassets/settingsimg/ball_" + id + ".dds";
	}
	...
	{
		return "data/sceneassets/ball/ball_" + ballId + ".rx3";
	}

	public static string RevModTeamBallModelFileName(int teamId)
	{
		return "data/sceneassets/ball/specificball_" + teamId + "_0_0.rx3";
	}

	public static string RevModTrophyBallModelFileName(int assetId)
	{
		return "data/sceneassets/ball/specificball_0_" + assetId + "_0.rx3";
	}
