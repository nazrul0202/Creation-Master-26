...
public class Stage : Compobj
{
	...
	public bool InsertGroup(int groupIndex)
	{
		...
		string typeString = "G" + (groupIndex + 1);
		Group obj = new Group(FifaEnvironment.CompetitionObjects.GetNewId(), typeString, " ", this);
		if (obj == null)
		{
			return false;
		}
		base.Groups.Insert(groupIndex, obj);
	...
	public override void Normalize()
	{
		...
		foreach (Group group2 in base.Groups)
		{
