...
public static class LabelMaps
{
    ...
    public static readonly Dictionary<string, string> Teams = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["teamstadiumcapacity"] = "Stadium Capacity",
        ["countryid"] = "Country",
        ["leagueid"] = "League",
        ["cityid"] = "City",
    ...
    public static readonly Dictionary<string, string> Players = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["playerjerseynameid"] = "Jersey Name (ref)",
    ...
    public static readonly Dictionary<string, string> Managers = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["managerjointeamdate"] = "Joined Team",
        ["headassetid"] = "Head Asset",
        ["headclasscode"] = "Head Class",
        ["headtypecode"] = "Head Type",
        ["headvariation"] = "Head Variation",
        ["hairstylecode"] = "Hair Style",
        ["hairtypecode"] = "Hair Type",
        ["haircolorcode"] = "Hair Colour",
        ["facialhairtypecode"] = "Facial Hair",
        ["facialhaircolorcode"] = "Facial Hair Colour",
        ["eyecolorcode"] = "Eye Colour",
        ["skintonecode"] = "Skin Tone",
        ["bodytypecode"] = "Body Type",
        ["outfitid"] = "Outfit",
        ["seasonaloutfitid"] = "Seasonal Outfit",
