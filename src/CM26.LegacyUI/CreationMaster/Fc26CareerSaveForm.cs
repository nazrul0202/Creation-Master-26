...
internal sealed class Fc26CareerSaveForm : Form
{
    ...
    internal Fc26CareerSaveForm()
    {
        ...
        var table = new TableLayoutPanel { Dock = DockStyle.Fill, Padding = new Padding(18), ColumnCount = 3, RowCount = 6 };
        ...
        table.Controls.Add(Label("Active club team ID"), 0, 1); table.Controls.Add(_club, 1, 1);
        table.Controls.Add(Label("Current transfer budget"), 0, 2); table.Controls.Add(_current, 1, 2);
        table.Controls.Add(Label("Start-of-season budget"), 0, 3); table.Controls.Add(_season, 1, 3);
        ...
        table.Controls.Add(actions, 0, 4); table.SetColumnSpan(actions, 3);
        _status.AutoSize = true; _status.ForeColor = Color.DarkGreen; table.Controls.Add(_status, 0, 5); table.SetColumnSpan(_status, 3);
    ...
    private async ThreadingTask LoadEditor(string fileName)
    {
        ...
        try
        {
            ...
            _file.Text = _editor.FileName; _club.Text = _editor.ClubTeamId.ToString();
    ...
    private static NumericUpDown MoneyBox() => new NumericUpDown { Maximum = 2000000000M, ThousandsSeparator = true, Width = 180 };
