...
/// via HelixToolkit's Assimp importer and renders it with orbit/zoom controls.
...
public partial class Mesh3DPreviewPanel : System.Windows.Controls.UserControl
{
    ...
    private Model3DGroup LoadMeshBackground(string fbxPath, string texturePath)
    {
        ...
        else
        {
            ...
            // so the mesh is visible on the dark background.
        ...
        var centre = bounds.Location + new Vector3D(bounds.SizeX / 2, bounds.SizeY / 2, bounds.SizeZ / 2);
