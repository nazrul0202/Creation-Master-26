# Installation — Creation Master 26 1.0.199
...
the download. Verify your download against `SHA256SUMS_v1.0.199.txt` if
...
Close FC26, run `Creation Master 26.exe`, then choose **File > Open FC26**. On the
...
The familiar Creation Master / CM16 desktop is the only interface. The previous
experimental Studio executable and command-line switches are not included.
...
2. Either place its folder next to `Creation Master 26.exe` named `CM26 Scraper`,
