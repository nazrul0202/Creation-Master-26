...
Status: Version 1.0.197 (MIT License), 2026-09-01.

## User interface

The v1.0.197 public launcher is named `Creation Master 26.exe` and opens only the familiar Creation Master / CM16-style interface. There is no separate Studio executable or Studio launch switch. The x64 host remains behind the classic interface for Frostbite database, asset and preview work. Exotic DPI combinations or very small window sizes may still need refinement.
