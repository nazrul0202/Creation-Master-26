...
Status: Version 1.0.154 (MIT License), 2026-08-25.

## User interface

The v1.0.154 public launcher preserves the original Creation Master / CM16-style interface used by v1.0.148. The x64 Frostbite host runs behind that interface; the internal modern Studio is available only with `--studio`. Exotic DPI combinations or very small window sizes may still need refinement.
