...
Status: Version 1.0.159 (MIT License), 2026-08-25.

## User interface

The v1.0.159 public launcher preserves the original Creation Master / CM16-style interface used by v1.0.148. Specialist workflows are embedded into the relevant original editor sections instead of a global tools bar or floating Player panel. The x64 Frostbite host runs behind that interface; the internal modern Studio is available only with `--studio`. Exotic DPI combinations or very small window sizes may still need refinement.
